...
colnames(mydetP2) <- c("cR7_detPvalue","cG13_detPvalue","cR35_detPvalue","cG50_detPvalue","D2SU_detPvalue","pG_detPvalue","pR_detPvalue","UN_detPvalue")
head(mydetP2)
dim(mydetP2)
...
colnames(myIUnmeth2) <- c("cR7_Unmethylated_Signal","cG13_Unmethylated_Signal","cR35_Unmethylated_Signal","cG50_Unmethylated_Signal","D2SU_Unmethylated_Signal","pG_Unmethylated_Signal","pR_Unmethylated_Signal","UN_Unmethylated_Signal")
head(myIUnmeth2)
dim(myIUnmeth2)
...
colnames(myIMeth2) <- c("cR7_Methylated_Signal","cG13_Methylated_Signal","cR35_Methylated_Signal","cG50_Methylated_Signal","D2SU_Methylated_Signal","pG_Methylated_Signal","pR_Methylated_Signal","UN_Methylated_Signal")
head(myIMeth2)
dim(myIMeth2)
...
Matrix_signal_intensitiesre <- Matrix_signal_intensities[,c(1,9,17,2,10,18,3,11,19,4,12,20,5,13,21,6,14,22,7,15,23,8,16,24)]
dim(Matrix_signal_intensitiesre)
head(Matrix_signal_intensitiesre,1)
Matrix_signal_intensitiesre["probeID"] <- rownames(Matrix_signal_intensitiesre)
dim(Matrix_signal_intensitiesre)
Matrix_signal_intensitiesre <- Matrix_signal_intensitiesre[,c(25,1:24)]
write.table(Matrix_signal_intensitiesre,"/media/ankitv/Archivio2/ankit/Array21/GEOSubmission/avcnr/Matrix_signal_intensities.txt",row.names=FALSE,quote=FALSE, append=F,sep = "\t")
...
#GEO Submission file
matrix_processed <- MERGE_myiNorm3re_pos
colnames(matrix_processed) <- c("chr","start","end","TargetID","cR7","cG13","cR35","cG50","D2SU","pG","pR","UN")
write.table(matrix_processed, "/media/ankitv/Archivio2/ankit/Array21/GEOSubmission/avcnr/Matrix_processed.txt", col.names = T, quote = F, row.names = F, sep = "\t")
...
MERGE_myiNorm3re_pos_chravg["D250_Con"] <- MERGE_myiNorm3re_pos_chravg$D250 - MERGE_myiNorm3re_pos_chravg$Allcontrol
MERGE_myiNorm3re_pos_chravg["UN_Con"] <- MERGE_myiNorm3re_pos_chravg$UN - MERGE_myiNorm3re_pos_chravg$Allcontrol
...
MERGE_myiNorm3re_pos_chravg1 <- MERGE_myiNorm3re_pos_chravg1[,c(34:37,1:33)]
head(MERGE_myiNorm3re_pos_chravg1)
...
miMERGE_myiNorm3re_pos_chravg_PG <- miMERGE_myiNorm3re_pos_chravg_PG[which(miMERGE_myiNorm3re_pos_chravg_PG$D250_Con < 0.1 & 
                                                                             miMERGE_myiNorm3re_pos_chravg_PG$D250_Con > -0.1),]


miMERGE_myiNorm3re_pos_chravg_PG <- miMERGE_myiNorm3re_pos_chravg_PG[which(miMERGE_myiNorm3re_pos_chravg_PG$UN_Con < 0.1 & 
                                                                             miMERGE_myiNorm3re_pos_chravg_PG$UN_Con > -0.1),]
...
miMERGE_myiNorm3re_pos_chravg_PR <- miMERGE_myiNorm3re_pos_chravg_PR[which(miMERGE_myiNorm3re_pos_chravg_PR$D250_Con < 0.1 & 
                                                                             miMERGE_myiNorm3re_pos_chravg_PR$D250_Con > -0.1),]

miMERGE_myiNorm3re_pos_chravg_PR <- miMERGE_myiNorm3re_pos_chravg_PR[which(miMERGE_myiNorm3re_pos_chravg_PR$UN_Con < 0.1 & 
                                                                             miMERGE_myiNorm3re_pos_chravg_PR$UN_Con > -0.1),]
...
#Get Hypo and Hyper 
#Filter by beta value differencepMERGE_myiNorm3re_pos_chravg2
#PG specific diff meth CpGs +/- 0.2
pMERGE_myiNorm3re_pos_chravg_PG_Hyper <- pMERGE_myiNorm3re_pos_chravg2[which(pMERGE_myiNorm3re_pos_chravg2$PG_Con > 0.2),]
#Should not be Hyper in any controls 
pMERGE_myiNorm3re_pos_chravg_PG_Hyper <- pMERGE_myiNorm3re_pos_chravg_PG_Hyper[which(pMERGE_myiNorm3re_pos_chravg_PG_Hyper$D250_Con < 0.2),]
pMERGE_myiNorm3re_pos_chravg_PG_Hyper <- pMERGE_myiNorm3re_pos_chravg_PG_Hyper[which(pMERGE_myiNorm3re_pos_chravg_PG_Hyper$UN_Con < 0.2),]

dim(pMERGE_myiNorm3re_pos_chravg_PG_Hyper)
miMERGE_myiNorm3re_pos_chravg_PG_Hyper <- pMERGE_myiNorm3re_pos_chravg_PG_Hyper
head(miMERGE_myiNorm3re_pos_chravg_PG_Hyper)
dim(miMERGE_myiNorm3re_pos_chravg_PG_Hyper)



pMERGE_myiNorm3re_pos_chravg_PG_Hypo <- pMERGE_myiNorm3re_pos_chravg2[which(pMERGE_myiNorm3re_pos_chravg2$PG_Con < -0.2),]
#Should not be Hypo in any controls 
pMERGE_myiNorm3re_pos_chravg_PG_Hypo <- pMERGE_myiNorm3re_pos_chravg_PG_Hypo[which(pMERGE_myiNorm3re_pos_chravg_PG_Hypo$D250_Con > -0.2),]
pMERGE_myiNorm3re_pos_chravg_PG_Hypo <- pMERGE_myiNorm3re_pos_chravg_PG_Hypo[which(pMERGE_myiNorm3re_pos_chravg_PG_Hypo$UN_Con > -0.2),]

dim(pMERGE_myiNorm3re_pos_chravg_PG_Hypo)


miMERGE_myiNorm3re_pos_chravg_PG_Hypo <- pMERGE_myiNorm3re_pos_chravg_PG_Hypo
head(miMERGE_myiNorm3re_pos_chravg_PG_Hypo)
dim(miMERGE_myiNorm3re_pos_chravg_PG_Hypo)


#Filter by difference of beta values
#PR specific diff meth CpGs +/- 0.2
pMERGE_myiNorm3re_pos_chravg_PR_Hyper <- pMERGE_myiNorm3re_pos_chravg2[which(pMERGE_myiNorm3re_pos_chravg2$PR_Con > 0.2),]
#Should not be Hyper in any controls 
pMERGE_myiNorm3re_pos_chravg_PR_Hyper <- pMERGE_myiNorm3re_pos_chravg_PR_Hyper[which(pMERGE_myiNorm3re_pos_chravg_PR_Hyper$D250_Con < 0.2),]
pMERGE_myiNorm3re_pos_chravg_PR_Hyper <- pMERGE_myiNorm3re_pos_chravg_PR_Hyper[which(pMERGE_myiNorm3re_pos_chravg_PR_Hyper$UN_Con < 0.2),]

dim(pMERGE_myiNorm3re_pos_chravg_PR_Hyper)
miMERGE_myiNorm3re_pos_chravg_PR_Hyper <- pMERGE_myiNorm3re_pos_chravg_PR_Hyper
head(miMERGE_myiNorm3re_pos_chravg_PR_Hyper)
dim(miMERGE_myiNorm3re_pos_chravg_PR_Hyper)



pMERGE_myiNorm3re_pos_chravg_PR_Hypo <- pMERGE_myiNorm3re_pos_chravg2[which(pMERGE_myiNorm3re_pos_chravg2$PR_Con < -0.2),]
#Should not be Hypo in any controls 
pMERGE_myiNorm3re_pos_chravg_PR_Hypo <- pMERGE_myiNorm3re_pos_chravg_PR_Hypo[which(pMERGE_myiNorm3re_pos_chravg_PR_Hypo$D250_Con > -0.2),]
pMERGE_myiNorm3re_pos_chravg_PR_Hypo <- pMERGE_myiNorm3re_pos_chravg_PR_Hypo[which(pMERGE_myiNorm3re_pos_chravg_PR_Hypo$UN_Con > -0.2),]

dim(pMERGE_myiNorm3re_pos_chravg_PR_Hypo)


miMERGE_myiNorm3re_pos_chravg_PR_Hypo <- pMERGE_myiNorm3re_pos_chravg_PR_Hypo
head(miMERGE_myiNorm3re_pos_chravg_PR_Hypo)
dim(miMERGE_myiNorm3re_pos_chravg_PR_Hypo)


miMERGE_myiNorm3re_chrpos_avg_PG <- rbind.data.frame(miMERGE_myiNorm3re_pos_chravg_PG_Hypo, miMERGE_myiNorm3re_pos_chravg_PG_Hyper)
miMERGE_myiNorm3re_chrpos_avg_PR <- rbind.data.frame(miMERGE_myiNorm3re_pos_chravg_PR_Hypo, miMERGE_myiNorm3re_pos_chravg_PR_Hyper)
dim(miMERGE_myiNorm3re_chrpos_avg_PG)
dim(miMERGE_myiNorm3re_chrpos_avg_PR)


#Recovery in corrected clones
dim(miMERGE_myiNorm3re_pos_chravg_PG_Hypo)
dim(miMERGE_myiNorm3re_pos_chravg_PG_Hyper)
dim(miMERGE_myiNorm3re_pos_chravg_PR_Hypo)
dim(miMERGE_myiNorm3re_pos_chravg_PR_Hyper)

miMERGE_myiNorm3re_pos_chravg_PG_Hypo_PGsdev <- data.frame(miMERGE_myiNorm3re_pos_chravg_PG_Hypo)
miMERGE_myiNorm3re_pos_chravg_PG_Hypo_PGsdev["rowCpG"] <- paste0(miMERGE_myiNorm3re_pos_chravg_PG_Hypo_PGsdev$row_1, "%", miMERGE_myiNorm3re_pos_chravg_PG_Hypo_PGsdev$row_2, "%", miMERGE_myiNorm3re_pos_chravg_PG_Hypo_PGsdev$row_3)
miMERGE_myiNorm3re_pos_chravg_PG_Hypo_C13sdev_rec <- miMERGE_myiNorm3re_pos_chravg_PG_Hypo[which(miMERGE_myiNorm3re_pos_chravg_PG_Hypo$C13_Con > -0.2),]
dim(miMERGE_myiNorm3re_pos_chravg_PG_Hypo_C13sdev_rec)
miMERGE_myiNorm3re_pos_chravg_PG_Hypo_C13sdev_rec <- data.frame(miMERGE_myiNorm3re_pos_chravg_PG_Hypo_C13sdev_rec)
miMERGE_myiNorm3re_pos_chravg_PG_Hypo_C13sdev_rec["rowCpG"] <- paste0(miMERGE_myiNorm3re_pos_chravg_PG_Hypo_C13sdev_rec$row_1, "%", miMERGE_myiNorm3re_pos_chravg_PG_Hypo_C13sdev_rec$row_2, "%", miMERGE_myiNorm3re_pos_chravg_PG_Hypo_C13sdev_rec$row_3)
miMERGE_myiNorm3re_pos_chravg_PG_Hypo_C50sdev_rec <- miMERGE_myiNorm3re_pos_chravg_PG_Hypo[which(miMERGE_myiNorm3re_pos_chravg_PG_Hypo$C50_Con > -0.2),]
dim(miMERGE_myiNorm3re_pos_chravg_PG_Hypo_C50sdev_rec)
miMERGE_myiNorm3re_pos_chravg_PG_Hypo_C50sdev_rec <- data.frame(miMERGE_myiNorm3re_pos_chravg_PG_Hypo_C50sdev_rec)
miMERGE_myiNorm3re_pos_chravg_PG_Hypo_C50sdev_rec["rowCpG"] <- paste0(miMERGE_myiNorm3re_pos_chravg_PG_Hypo_C50sdev_rec$row_1, "%", miMERGE_myiNorm3re_pos_chravg_PG_Hypo_C50sdev_rec$row_2, "%", miMERGE_myiNorm3re_pos_chravg_PG_Hypo_C50sdev_rec$row_3)


miMERGE_myiNorm3re_pos_chravg_PR_Hypo_PRsdev <- data.frame(miMERGE_myiNorm3re_pos_chravg_PR_Hypo)
miMERGE_myiNorm3re_pos_chravg_PR_Hypo_PRsdev["rowCpG"] <- paste0(miMERGE_myiNorm3re_pos_chravg_PR_Hypo_PRsdev$row_1, "%", miMERGE_myiNorm3re_pos_chravg_PR_Hypo_PRsdev$row_2, "%", miMERGE_myiNorm3re_pos_chravg_PR_Hypo_PRsdev$row_3)
miMERGE_myiNorm3re_pos_chravg_PR_Hypo_C7sdev_rec <- miMERGE_myiNorm3re_pos_chravg_PR_Hypo[which(miMERGE_myiNorm3re_pos_chravg_PR_Hypo$C7_Con > -0.2),]
dim(miMERGE_myiNorm3re_pos_chravg_PR_Hypo_C7sdev_rec)
miMERGE_myiNorm3re_pos_chravg_PR_Hypo_C7sdev_rec <- data.frame(miMERGE_myiNorm3re_pos_chravg_PR_Hypo_C7sdev_rec)
miMERGE_myiNorm3re_pos_chravg_PR_Hypo_C7sdev_rec["rowCpG"] <- paste0(miMERGE_myiNorm3re_pos_chravg_PR_Hypo_C7sdev_rec$row_1, "%", miMERGE_myiNorm3re_pos_chravg_PR_Hypo_C7sdev_rec$row_2, "%", miMERGE_myiNorm3re_pos_chravg_PR_Hypo_C7sdev_rec$row_3)
miMERGE_myiNorm3re_pos_chravg_PR_Hypo_C35sdev_rec <- miMERGE_myiNorm3re_pos_chravg_PR_Hypo[which(miMERGE_myiNorm3re_pos_chravg_PR_Hypo$C35_Con > -0.2),]
dim(miMERGE_myiNorm3re_pos_chravg_PR_Hypo_C35sdev_rec)
miMERGE_myiNorm3re_pos_chravg_PR_Hypo_C35sdev_rec <- data.frame(miMERGE_myiNorm3re_pos_chravg_PR_Hypo_C35sdev_rec)
miMERGE_myiNorm3re_pos_chravg_PR_Hypo_C35sdev_rec["rowCpG"] <- paste0(miMERGE_myiNorm3re_pos_chravg_PR_Hypo_C35sdev_rec$row_1, "%", miMERGE_myiNorm3re_pos_chravg_PR_Hypo_C35sdev_rec$row_2, "%", miMERGE_myiNorm3re_pos_chravg_PR_Hypo_C35sdev_rec$row_3)


miMERGE_myiNorm3re_pos_chravg_PG_Hyper_PGsdev <- data.frame(miMERGE_myiNorm3re_pos_chravg_PG_Hyper)
miMERGE_myiNorm3re_pos_chravg_PG_Hyper_PGsdev["rowCpG"] <- paste0(miMERGE_myiNorm3re_pos_chravg_PG_Hyper_PGsdev$row_1, "%", miMERGE_myiNorm3re_pos_chravg_PG_Hyper_PGsdev$row_2, "%", miMERGE_myiNorm3re_pos_chravg_PG_Hyper_PGsdev$row_3)
miMERGE_myiNorm3re_pos_chravg_PG_Hyper_C13sdev_rec <- miMERGE_myiNorm3re_pos_chravg_PG_Hyper[which(miMERGE_myiNorm3re_pos_chravg_PG_Hyper$C13_Con < 0.2),]
dim(miMERGE_myiNorm3re_pos_chravg_PG_Hyper_C13sdev_rec)
miMERGE_myiNorm3re_pos_chravg_PG_Hyper_C13sdev_rec <- data.frame(miMERGE_myiNorm3re_pos_chravg_PG_Hyper_C13sdev_rec)
miMERGE_myiNorm3re_pos_chravg_PG_Hyper_C13sdev_rec["rowCpG"] <- paste0(miMERGE_myiNorm3re_pos_chravg_PG_Hyper_C13sdev_rec$row_1, "%", miMERGE_myiNorm3re_pos_chravg_PG_Hyper_C13sdev_rec$row_2, "%", miMERGE_myiNorm3re_pos_chravg_PG_Hyper_C13sdev_rec$row_3)
miMERGE_myiNorm3re_pos_chravg_PG_Hyper_C50sdev_rec <- miMERGE_myiNorm3re_pos_chravg_PG_Hyper[which(miMERGE_myiNorm3re_pos_chravg_PG_Hyper$C50_Con < 0.2),]
dim(miMERGE_myiNorm3re_pos_chravg_PG_Hyper_C50sdev_rec)
miMERGE_myiNorm3re_pos_chravg_PG_Hyper_C50sdev_rec <- data.frame(miMERGE_myiNorm3re_pos_chravg_PG_Hyper_C50sdev_rec)
miMERGE_myiNorm3re_pos_chravg_PG_Hyper_C50sdev_rec["rowCpG"] <- paste0(miMERGE_myiNorm3re_pos_chravg_PG_Hyper_C50sdev_rec$row_1, "%", miMERGE_myiNorm3re_pos_chravg_PG_Hyper_C50sdev_rec$row_2, "%", miMERGE_myiNorm3re_pos_chravg_PG_Hyper_C50sdev_rec$row_3)


miMERGE_myiNorm3re_pos_chravg_PR_Hyper_PRsdev <- data.frame(miMERGE_myiNorm3re_pos_chravg_PR_Hyper)
miMERGE_myiNorm3re_pos_chravg_PR_Hyper_PRsdev["rowCpG"] <- paste0(miMERGE_myiNorm3re_pos_chravg_PR_Hyper_PRsdev$row_1, "%", miMERGE_myiNorm3re_pos_chravg_PR_Hyper_PRsdev$row_2, "%", miMERGE_myiNorm3re_pos_chravg_PR_Hyper_PRsdev$row_3)
miMERGE_myiNorm3re_pos_chravg_PR_Hyper_C7sdev_rec <- miMERGE_myiNorm3re_pos_chravg_PR_Hyper[which(miMERGE_myiNorm3re_pos_chravg_PR_Hyper$C7_Con < 0.2),]
dim(miMERGE_myiNorm3re_pos_chravg_PR_Hyper_C7sdev_rec)
miMERGE_myiNorm3re_pos_chravg_PR_Hyper_C7sdev_rec <- data.frame(miMERGE_myiNorm3re_pos_chravg_PR_Hyper_C7sdev_rec)
miMERGE_myiNorm3re_pos_chravg_PR_Hyper_C7sdev_rec["rowCpG"] <- paste0(miMERGE_myiNorm3re_pos_chravg_PR_Hyper_C7sdev_rec$row_1, "%", miMERGE_myiNorm3re_pos_chravg_PR_Hyper_C7sdev_rec$row_2, "%", miMERGE_myiNorm3re_pos_chravg_PR_Hyper_C7sdev_rec$row_3)
miMERGE_myiNorm3re_pos_chravg_PR_Hyper_C35sdev_rec <- miMERGE_myiNorm3re_pos_chravg_PR_Hyper[which(miMERGE_myiNorm3re_pos_chravg_PR_Hyper$C35_Con < 0.2),]
dim(miMERGE_myiNorm3re_pos_chravg_PR_Hyper_C35sdev_rec)
miMERGE_myiNorm3re_pos_chravg_PR_Hyper_C35sdev_rec <- data.frame(miMERGE_myiNorm3re_pos_chravg_PR_Hyper_C35sdev_rec)
miMERGE_myiNorm3re_pos_chravg_PR_Hyper_C35sdev_rec["rowCpG"] <- paste0(miMERGE_myiNorm3re_pos_chravg_PR_Hyper_C35sdev_rec$row_1, "%", miMERGE_myiNorm3re_pos_chravg_PR_Hyper_C35sdev_rec$row_2, "%", miMERGE_myiNorm3re_pos_chravg_PR_Hyper_C35sdev_rec$row_3)


#Find genome-wide differentially methylated CpGs based on M val and Beta cutoff
dim(MERGE_myiNorm3re_pos_chr)
head(MERGE_myiNorm3re_pos_chr)

MERGE_myiNorm3re_pos_chr_Betaval <- MERGE_myiNorm3re_pos_chr[,4:12]
rownames(MERGE_myiNorm3re_pos_chr_Betaval) <- MERGE_myiNorm3re_pos_chr_Betaval$probeID
MERGE_myiNorm3re_pos_chr_Betaval <- MERGE_myiNorm3re_pos_chr_Betaval[,-1]
head(MERGE_myiNorm3re_pos_chr_Betaval)
#Convert Beta to M-values
MERGE_myiNorm3re_pos_chr_Mval <- lumi::beta2m(MERGE_myiNorm3re_pos_chr_Betaval)
head(MERGE_myiNorm3re_pos_chr_Mval)
summary(MERGE_myiNorm3re_pos_chr_Mval)
colnames(MERGE_myiNorm3re_pos_chr_Mval) <- paste0(colnames(MERGE_myiNorm3re_pos_chr_Mval), "_Mval")

MERGE_myiNorm3re_pos_chr_Mvalre <- MERGE_myiNorm3re_pos_chr_Mval[,c(5,8,6,7,1:4)]
head(MERGE_myiNorm3re_pos_chr_Mvalre,3)

MERGE_myiNorm3re_pos_chr_Mvalre <- as.matrix(MERGE_myiNorm3re_pos_chr_Mvalre)
MERGE_myiNorm3re_pos_chr_Mvalavg <- data.frame(cbind(
  (rowMeans(MERGE_myiNorm3re_pos_chr_Mvalre[,1:2])),
  3 * (rowSds(MERGE_myiNorm3re_pos_chr_Mvalre[,1:2])),
  (MERGE_myiNorm3re_pos_chr_Mvalre[,1:8])
))
...
head(MERGE_myiNorm3re_pos_chr_Mvalavg,2)
colnames(MERGE_myiNorm3re_pos_chr_Mvalavg) <- c("Meancontrol_Mval","Mval_3Sdcontrol",colnames(MERGE_myiNorm3re_pos_chr_Mvalre))
dim(MERGE_myiNorm3re_pos_chr_Mvalavg)
head(MERGE_myiNorm3re_pos_chr_Mvalavg)

#Subtraction, Control -Control
MERGE_myiNorm3re_pos_chr_Mvalavg["Con_Con_Mval"] <- abs(MERGE_myiNorm3re_pos_chr_Mvalavg$Meancontrol_Mval - MERGE_myiNorm3re_pos_chr_Mvalavg$Meancontrol_Mval)
MERGE_myiNorm3re_pos_chr_Mvalavg["D250_Con_Mval"] <- abs(MERGE_myiNorm3re_pos_chr_Mvalavg$D250_Mval - MERGE_myiNorm3re_pos_chr_Mvalavg$Meancontrol_Mval)
MERGE_myiNorm3re_pos_chr_Mvalavg["UN_Con_Mval"] <- abs(MERGE_myiNorm3re_pos_chr_Mvalavg$UN_Mval - MERGE_myiNorm3re_pos_chr_Mvalavg$Meancontrol_Mval)

#Subtraction, Case -Control
MERGE_myiNorm3re_pos_chr_Mvalavg["PG_Con_Mval"] <- abs(MERGE_myiNorm3re_pos_chr_Mvalavg$PG_Mval - MERGE_myiNorm3re_pos_chr_Mvalavg$Meancontrol_Mval)
MERGE_myiNorm3re_pos_chr_Mvalavg["PR_Con_Mval"] <- abs(MERGE_myiNorm3re_pos_chr_Mvalavg$PR_Mval - MERGE_myiNorm3re_pos_chr_Mvalavg$Meancontrol_Mval)
MERGE_myiNorm3re_pos_chr_Mvalavg["C7_Con_Mval"] <- abs(MERGE_myiNorm3re_pos_chr_Mvalavg$C7_Mval - MERGE_myiNorm3re_pos_chr_Mvalavg$Meancontrol_Mval)
MERGE_myiNorm3re_pos_chr_Mvalavg["C13_Con_Mval"] <- abs(MERGE_myiNorm3re_pos_chr_Mvalavg$C13_Mval - MERGE_myiNorm3re_pos_chr_Mvalavg$Meancontrol_Mval)
MERGE_myiNorm3re_pos_chr_Mvalavg["C35_Con_Mval"] <- abs(MERGE_myiNorm3re_pos_chr_Mvalavg$C35_Mval - MERGE_myiNorm3re_pos_chr_Mvalavg$Meancontrol_Mval)
MERGE_myiNorm3re_pos_chr_Mvalavg["C50_Con_Mval"] <- abs(MERGE_myiNorm3re_pos_chr_Mvalavg$C50_Mval - MERGE_myiNorm3re_pos_chr_Mvalavg$Meancontrol_Mval)
MERGE_myiNorm3re_pos_chr_Mvalavg["C7_PR_Mval"] <- abs(MERGE_myiNorm3re_pos_chr_Mvalavg$C7_Mval - MERGE_myiNorm3re_pos_chr_Mvalavg$PR_Mval)
MERGE_myiNorm3re_pos_chr_Mvalavg["C13_PG_Mval"] <- abs(MERGE_myiNorm3re_pos_chr_Mvalavg$C13_Mval - MERGE_myiNorm3re_pos_chr_Mvalavg$PG_Mval)
MERGE_myiNorm3re_pos_chr_Mvalavg["C35_PR_Mval"] <- abs(MERGE_myiNorm3re_pos_chr_Mvalavg$C35_Mval - MERGE_myiNorm3re_pos_chr_Mvalavg$PR_Mval)
MERGE_myiNorm3re_pos_chr_Mvalavg["C50_PG_Mval"] <- abs(MERGE_myiNorm3re_pos_chr_Mvalavg$C50_Mval - MERGE_myiNorm3re_pos_chr_Mvalavg$PG_Mval)

MERGE_myiNorm3re_pos_chr_Mvalavg$probeID <- rownames(MERGE_myiNorm3re_pos_chr_Mvalavg)
head(MERGE_myiNorm3re_pos_chr_Mvalavg)
dim(MERGE_myiNorm3re_pos_chr_Mvalavg)

#Process beta value 
MERGE_myiBvNorm3re_pos_chr <- MERGE_myiNorm3re_pos_chr
head(MERGE_myiBvNorm3re_pos_chr)
dim(MERGE_myiBvNorm3re_pos_chr) 

rownames(MERGE_myiBvNorm3re_pos_chr) <- paste0(MERGE_myiBvNorm3re_pos_chr$chr, 
                                               "%",
                                               MERGE_myiBvNorm3re_pos_chr$start,
                                               "%",
                                               MERGE_myiBvNorm3re_pos_chr$end,
                                               "%",
                                               MERGE_myiBvNorm3re_pos_chr$probeID)

MERGE_myiBvNorm3re_pos_chrPre <- MERGE_myiBvNorm3re_pos_chr[,-(1:4)]
head(MERGE_myiBvNorm3re_pos_chrPre)
dim(MERGE_myiBvNorm3re_pos_chrPre)
MERGE_myiBvNorm3re_pos_chrPre <- MERGE_myiBvNorm3re_pos_chrPre[,c(5,8,6,7,1:4)]
head(MERGE_myiBvNorm3re_pos_chrPre)
dim(MERGE_myiBvNorm3re_pos_chrPre)
MERGE_myiBvNorm3re_pos_chrPre <- as.matrix(MERGE_myiBvNorm3re_pos_chrPre)
MERGE_myiBvNorm3re_pos_chravg <- data.frame(cbind((rowMedians(MERGE_myiBvNorm3re_pos_chrPre[,1:2])),
                                                  (MERGE_myiBvNorm3re_pos_chrPre[,1:8])))

head(MERGE_myiBvNorm3re_pos_chravg)
colnames(MERGE_myiBvNorm3re_pos_chravg) <- c("Allcontrol",colnames(MERGE_myiBvNorm3re_pos_chrPre))
dim(MERGE_myiBvNorm3re_pos_chravg)


#Subtraction, Control -Control
MERGE_myiBvNorm3re_pos_chravg["Con_Con"] <- MERGE_myiBvNorm3re_pos_chravg$Allcontrol - MERGE_myiBvNorm3re_pos_chravg$Allcontrol
MERGE_myiBvNorm3re_pos_chravg["D250_Con"] <- MERGE_myiBvNorm3re_pos_chravg$D250 - MERGE_myiBvNorm3re_pos_chravg$Allcontrol
MERGE_myiBvNorm3re_pos_chravg["UN_Con"] <- MERGE_myiBvNorm3re_pos_chravg$UN - MERGE_myiBvNorm3re_pos_chravg$Allcontrol

head(MERGE_myiBvNorm3re_pos_chravg)
#Subtraction, Case -Control
MERGE_myiBvNorm3re_pos_chravg["PG_Con"] <- MERGE_myiBvNorm3re_pos_chravg$PG - MERGE_myiBvNorm3re_pos_chravg$Allcontrol
MERGE_myiBvNorm3re_pos_chravg["PR_Con"] <- MERGE_myiBvNorm3re_pos_chravg$PR - MERGE_myiBvNorm3re_pos_chravg$Allcontrol
MERGE_myiBvNorm3re_pos_chravg["C7_Con"] <- MERGE_myiBvNorm3re_pos_chravg$C7 - MERGE_myiBvNorm3re_pos_chravg$Allcontrol
MERGE_myiBvNorm3re_pos_chravg["C13_Con"] <- MERGE_myiBvNorm3re_pos_chravg$C13 - MERGE_myiBvNorm3re_pos_chravg$Allcontrol
MERGE_myiBvNorm3re_pos_chravg["C35_Con"] <- MERGE_myiBvNorm3re_pos_chravg$C35 - MERGE_myiBvNorm3re_pos_chravg$Allcontrol
MERGE_myiBvNorm3re_pos_chravg["C50_Con"] <- MERGE_myiBvNorm3re_pos_chravg$C50 - MERGE_myiBvNorm3re_pos_chravg$Allcontrol
MERGE_myiBvNorm3re_pos_chravg["C7_PR"] <- MERGE_myiBvNorm3re_pos_chravg$C7 - MERGE_myiBvNorm3re_pos_chravg$PR
MERGE_myiBvNorm3re_pos_chravg["C13_PG"] <- MERGE_myiBvNorm3re_pos_chravg$C13 - MERGE_myiBvNorm3re_pos_chravg$PG
MERGE_myiBvNorm3re_pos_chravg["C35_PR"] <- MERGE_myiBvNorm3re_pos_chravg$C35 - MERGE_myiBvNorm3re_pos_chravg$PR
MERGE_myiBvNorm3re_pos_chravg["C50_PG"] <- MERGE_myiBvNorm3re_pos_chravg$C50 - MERGE_myiBvNorm3re_pos_chravg$PG

head(MERGE_myiBvNorm3re_pos_chravg)
dim(MERGE_myiBvNorm3re_pos_chravg)
#write.table(MERGE_myiBvNorm3re_pos_chravg, "MERGE_myiBvNorm3re_pos_chravg.txt", sep = "\t", quote = F, append = F, row.names = F, col.names = T)
MERGE_myiBvNorm3re_pos_chravg1 <- MERGE_myiBvNorm3re_pos_chravg
MERGE_myiBvNorm3re_pos_chravg1["row"] <- rownames(MERGE_myiBvNorm3re_pos_chravg1)
MERGE_myiBvNorm3re_pos_chravg1 <- cSplit(MERGE_myiBvNorm3re_pos_chravg1, "row", "%")
head(MERGE_myiBvNorm3re_pos_chravg1)
dim(MERGE_myiBvNorm3re_pos_chravg1)
MERGE_myiBvNorm3re_pos_chravg1 <- MERGE_myiBvNorm3re_pos_chravg1[,c(23:26,1:22)]
head(MERGE_myiBvNorm3re_pos_chravg1)
write.table(MERGE_myiBvNorm3re_pos_chravg1, "MERGE_myiBvNorm3re_pos_chravg1.txt", sep = "\t", quote = F, append = F, row.names = F, col.names = F)
write.table(MERGE_myiBvNorm3re_pos_chravg1, "MERGE_myiBvNorm3re_pos_chravg2.txt", sep = "\t", quote = F, append = F, row.names = F, col.names = T)


#Sample specific diff meth CpGs
pMERGE_myiMBvNorm3re_pos_chravg2 <- merge(MERGE_myiBvNorm3re_pos_chravg1, MERGE_myiNorm3re_pos_chr_Mvalavg, by.x="row_4",by.y="probeID", all.x=T) 


dim(pMERGE_myiMBvNorm3re_pos_chravg2)
head(pMERGE_myiMBvNorm3re_pos_chravg2)

#Apply the formula for  abs(meanControlMval - sampleMval) >= 3SD

pMERGE_myiMBvNorm3re_pos_chravg2_PGdev <- pMERGE_myiMBvNorm3re_pos_chravg2[which(pMERGE_myiMBvNorm3re_pos_chravg2$PG_Con_Mval >= pMERGE_myiMBvNorm3re_pos_chravg2$Mval_3Sdcontrol),]
dim(pMERGE_myiMBvNorm3re_pos_chravg2_PGdev)

#Now filter by beta value difference
#PG specific diff meth CpGs +/- 0.2
pMERGE_myiMBvNorm3re_pos_chravg_PG_Hyper <- pMERGE_myiMBvNorm3re_pos_chravg2_PGdev[which(pMERGE_myiMBvNorm3re_pos_chravg2_PGdev$PG_Con > 0.2),]
#Should not be Hyper in any controls 
pMERGE_myiMBvNorm3re_pos_chravg_PG_Hyper <- pMERGE_myiMBvNorm3re_pos_chravg_PG_Hyper[which(pMERGE_myiMBvNorm3re_pos_chravg_PG_Hyper$D250_Con < 0.2),]
pMERGE_myiMBvNorm3re_pos_chravg_PG_Hyper <- pMERGE_myiMBvNorm3re_pos_chravg_PG_Hyper[which(pMERGE_myiMBvNorm3re_pos_chravg_PG_Hyper$UN_Con < 0.2),]

dim(pMERGE_myiMBvNorm3re_pos_chravg_PG_Hyper)
miMERGE_myiMBvNorm3re_pos_chravg_PG_Hyper <- pMERGE_myiMBvNorm3re_pos_chravg_PG_Hyper
head(miMERGE_myiMBvNorm3re_pos_chravg_PG_Hyper)
dim(miMERGE_myiMBvNorm3re_pos_chravg_PG_Hyper)
miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hyper <- miMERGE_myiMBvNorm3re_pos_chravg_PG_Hyper[,c(2:4,1,5:49)]
head(miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hyper)
dim(miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hyper)
write.table(miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hyper, "miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hyper.txt", sep = "\t", quote = F, append = F, row.names = T, col.names = T)
write.table(miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hyper$row_4, "miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hyper.id", sep = "\t", quote = F, append = F, row.names = T, col.names = T)
write.table(miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hyper, "miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hyper_chr.txt", sep = "\t", quote = F, append = F, row.names = F, col.names = F)


pMERGE_myiMBvNorm3re_pos_chravg_PG_Hypo <- pMERGE_myiMBvNorm3re_pos_chravg2_PGdev[which(pMERGE_myiMBvNorm3re_pos_chravg2_PGdev$PG_Con < -0.2),]
#Should not be Hypo in any controls 
pMERGE_myiMBvNorm3re_pos_chravg_PG_Hypo <- pMERGE_myiMBvNorm3re_pos_chravg_PG_Hypo[which(pMERGE_myiMBvNorm3re_pos_chravg_PG_Hypo$D250_Con > -0.2),]
pMERGE_myiMBvNorm3re_pos_chravg_PG_Hypo <- pMERGE_myiMBvNorm3re_pos_chravg_PG_Hypo[which(pMERGE_myiMBvNorm3re_pos_chravg_PG_Hypo$UN_Con > -0.2),]

dim(pMERGE_myiMBvNorm3re_pos_chravg_PG_Hypo)


miMERGE_myiMBvNorm3re_pos_chravg_PG_Hypo <- pMERGE_myiMBvNorm3re_pos_chravg_PG_Hypo
head(miMERGE_myiMBvNorm3re_pos_chravg_PG_Hypo)
dim(miMERGE_myiMBvNorm3re_pos_chravg_PG_Hypo)
miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hypo <- miMERGE_myiMBvNorm3re_pos_chravg_PG_Hypo[,c(2:4,1,5:49)]
head(miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hypo)
dim(miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hypo)
write.table(miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hypo, "miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hypo.txt", sep = "\t", quote = F, append = F, row.names = T, col.names = T)
write.table(miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hypo$row_4, "miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hypo.id", sep = "\t", quote = F, append = F, row.names = T, col.names = T)
write.table(miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hypo, "miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hypo_chr.txt", sep = "\t", quote = F, append = F, row.names = F, col.names = F)

#Apply the formula for  abs(meanControlMval - sampleMval) >= 3SD

pMERGE_myiMBvNorm3re_pos_chravg2_PRdev <- pMERGE_myiMBvNorm3re_pos_chravg2[which(pMERGE_myiMBvNorm3re_pos_chravg2$PR_Con_Mval >= pMERGE_myiMBvNorm3re_pos_chravg2$Mval_3Sdcontrol),]
dim(pMERGE_myiMBvNorm3re_pos_chravg2_PRdev)

#Now filter by difference of beta values
#PR specific diff meth CpGs +/- 0.2
pMERGE_myiMBvNorm3re_pos_chravg_PR_Hyper <- pMERGE_myiMBvNorm3re_pos_chravg2_PRdev[which(pMERGE_myiMBvNorm3re_pos_chravg2_PRdev$PR_Con > 0.2),]
#Should not be Hyper in any controls 
pMERGE_myiMBvNorm3re_pos_chravg_PR_Hyper <- pMERGE_myiMBvNorm3re_pos_chravg_PR_Hyper[which(pMERGE_myiMBvNorm3re_pos_chravg_PR_Hyper$D250_Con < 0.2),]
pMERGE_myiMBvNorm3re_pos_chravg_PR_Hyper <- pMERGE_myiMBvNorm3re_pos_chravg_PR_Hyper[which(pMERGE_myiMBvNorm3re_pos_chravg_PR_Hyper$UN_Con < 0.2),]

dim(pMERGE_myiMBvNorm3re_pos_chravg_PR_Hyper)
miMERGE_myiMBvNorm3re_pos_chravg_PR_Hyper <- pMERGE_myiMBvNorm3re_pos_chravg_PR_Hyper
head(miMERGE_myiMBvNorm3re_pos_chravg_PR_Hyper)
dim(miMERGE_myiMBvNorm3re_pos_chravg_PR_Hyper)
miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hyper <- miMERGE_myiMBvNorm3re_pos_chravg_PR_Hyper[,c(2:4,1,5:49)]
head(miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hyper)
dim(miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hyper)
write.table(miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hyper, "miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hyper.txt", sep = "\t", quote = F, append = F, row.names = T, col.names = T)
write.table(miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hyper$row_4, "miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hyper.id", sep = "\t", quote = F, append = F, row.names = T, col.names = T)
write.table(miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hyper, "miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hyper_chr.txt", sep = "\t", quote = F, append = F, row.names = F, col.names = F)


pMERGE_myiMBvNorm3re_pos_chravg_PR_Hypo <- pMERGE_myiMBvNorm3re_pos_chravg2_PRdev[which(pMERGE_myiMBvNorm3re_pos_chravg2_PRdev$PR_Con < -0.2),]
#Should not be Hypo in any controls 
pMERGE_myiMBvNorm3re_pos_chravg_PR_Hypo <- pMERGE_myiMBvNorm3re_pos_chravg_PR_Hypo[which(pMERGE_myiMBvNorm3re_pos_chravg_PR_Hypo$D250_Con > -0.2),]
pMERGE_myiMBvNorm3re_pos_chravg_PR_Hypo <- pMERGE_myiMBvNorm3re_pos_chravg_PR_Hypo[which(pMERGE_myiMBvNorm3re_pos_chravg_PR_Hypo$UN_Con > -0.2),]
dim(pMERGE_myiMBvNorm3re_pos_chravg_PR_Hypo)


miMERGE_myiMBvNorm3re_pos_chravg_PR_Hypo <- pMERGE_myiMBvNorm3re_pos_chravg_PR_Hypo
head(miMERGE_myiMBvNorm3re_pos_chravg_PR_Hypo)
dim(miMERGE_myiMBvNorm3re_pos_chravg_PR_Hypo)
miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hypo <- miMERGE_myiMBvNorm3re_pos_chravg_PR_Hypo[,c(2:4,1,5:49)]
head(miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hypo)
dim(miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hypo)
write.table(miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hypo, "miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hypo.txt", sep = "\t", quote = F, append = F, row.names = T, col.names = T)
write.table(miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hypo$row_4, "miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hypo.id", sep = "\t", quote = F, append = F, row.names = T, col.names = T)
write.table(miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hypo, "miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hypo_chr.txt", sep = "\t", quote = F, append = F, row.names = F, col.names = F)

miMERGE_myiMBvNorm3re_chrpos_avg_PG <- rbind.data.frame(miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hypo, miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hyper)
miMERGE_myiMBvNorm3re_chrpos_avg_PR <- rbind.data.frame(miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hypo, miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hyper)
dim(miMERGE_myiMBvNorm3re_chrpos_avg_PG)
dim(miMERGE_myiMBvNorm3re_chrpos_avg_PR)
...
miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hypo_PGsdev <- data.frame(miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hypo)
miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hypo_PGsdev["rowCpG"] <- paste0(miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hypo_PGsdev$row_1, "%", miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hypo_PGsdev$row_2, "%", miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hypo_PGsdev$row_3)
miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hypo_C13sdev <- miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hypo[which(miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hypo$C13_Con_Mval < miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hypo$Mval_3Sdcontrol),]
dim(miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hypo_C13sdev)
miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hypo_C13sdev_rec <- miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hypo_C13sdev[which(miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hypo_C13sdev$C13_Con > -0.2),]
dim(miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hypo_C13sdev_rec)
miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hypo_C13sdev_rec <- data.frame(miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hypo_C13sdev_rec)
miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hypo_C13sdev_rec["rowCpG"] <- paste0(miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hypo_C13sdev_rec$row_1, "%", miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hypo_C13sdev_rec$row_2, "%", miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hypo_C13sdev_rec$row_3)
miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hypo_C50sdev <- miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hypo[which(miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hypo$C50_Con_Mval < miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hypo$Mval_3Sdcontrol),]
dim(miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hypo_C50sdev)
miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hypo_C50sdev_rec <- miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hypo_C50sdev[which(miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hypo_C50sdev$C50_Con > -0.2),]
dim(miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hypo_C50sdev_rec)
miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hypo_C50sdev_rec <- data.frame(miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hypo_C50sdev_rec)
miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hypo_C50sdev_rec["rowCpG"] <- paste0(miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hypo_C50sdev_rec$row_1, "%", miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hypo_C50sdev_rec$row_2, "%", miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hypo_C50sdev_rec$row_3)


miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hypo_PRsdev <- data.frame(miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hypo)
miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hypo_PRsdev["rowCpG"] <- paste0(miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hypo_PRsdev$row_1, "%", miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hypo_PRsdev$row_2, "%", miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hypo_PRsdev$row_3)
miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hypo_C7sdev <- miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hypo[which(miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hypo$C7_Con_Mval < miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hypo$Mval_3Sdcontrol),]
dim(miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hypo_C7sdev)
miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hypo_C7sdev_rec <- miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hypo_C7sdev[which(miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hypo_C7sdev$C7_Con > -0.2),]
dim(miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hypo_C7sdev_rec)
miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hypo_C7sdev_rec <- data.frame(miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hypo_C7sdev_rec)
miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hypo_C7sdev_rec["rowCpG"] <- paste0(miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hypo_C7sdev_rec$row_1, "%", miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hypo_C7sdev_rec$row_2, "%", miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hypo_C7sdev_rec$row_3)
miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hypo_C35sdev <- miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hypo[which(miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hypo$C35_Con_Mval < miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hypo$Mval_3Sdcontrol),]
dim(miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hypo_C35sdev)
miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hypo_C35sdev_rec <- miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hypo_C35sdev[which(miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hypo_C35sdev$C35_Con > -0.2),]
dim(miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hypo_C35sdev_rec)
miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hypo_C35sdev_rec <- data.frame(miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hypo_C35sdev_rec)
miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hypo_C35sdev_rec["rowCpG"] <- paste0(miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hypo_C35sdev_rec$row_1, "%", miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hypo_C35sdev_rec$row_2, "%", miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hypo_C35sdev_rec$row_3)


miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hyper_PGsdev <- data.frame(miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hyper)
miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hyper_PGsdev["rowCpG"] <- paste0(miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hyper_PGsdev$row_1, "%", miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hyper_PGsdev$row_2, "%", miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hyper_PGsdev$row_3)
miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hyper_C13sdev <- miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hyper[which(miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hyper$C13_Con_Mval < miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hyper$Mval_3Sdcontrol),]
dim(miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hyper_C13sdev)
miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hyper_C13sdev_rec <- miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hyper_C13sdev[which(miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hyper_C13sdev$C13_Con < 0.2),]
dim(miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hyper_C13sdev_rec)
miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hyper_C13sdev_rec <- data.frame(miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hyper_C13sdev_rec)
miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hyper_C13sdev_rec["rowCpG"] <- paste0(miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hyper_C13sdev_rec$row_1, "%", miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hyper_C13sdev_rec$row_2, "%", miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hyper_C13sdev_rec$row_3)
miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hyper_C50sdev <- miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hyper[which(miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hyper$C50_Con_Mval < miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hyper$Mval_3Sdcontrol),]
dim(miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hyper_C50sdev)
miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hyper_C50sdev_rec <- miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hyper_C50sdev[which(miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hyper_C50sdev$C50_Con < 0.2),]
dim(miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hyper_C50sdev_rec)
miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hyper_C50sdev_rec <- data.frame(miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hyper_C50sdev_rec)
miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hyper_C50sdev_rec["rowCpG"] <- paste0(miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hyper_C50sdev_rec$row_1, "%", miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hyper_C50sdev_rec$row_2, "%", miMERGE_myiMBvNorm3re_chrpos_avg_PG_Hyper_C50sdev_rec$row_3)


miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hyper_PRsdev <- data.frame(miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hyper)
miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hyper_PRsdev["rowCpG"] <- paste0(miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hyper_PRsdev$row_1, "%", miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hyper_PRsdev$row_2, "%", miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hyper_PRsdev$row_3)
miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hyper_C7sdev <- miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hyper[which(miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hyper$C7_Con_Mval < miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hyper$Mval_3Sdcontrol),]
dim(miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hyper_C7sdev)
miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hyper_C7sdev_rec <- miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hyper_C7sdev[which(miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hyper_C7sdev$C7_Con < 0.2),]
dim(miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hyper_C7sdev_rec)
miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hyper_C7sdev_rec <- data.frame(miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hyper_C7sdev_rec)
miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hyper_C7sdev_rec["rowCpG"] <- paste0(miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hyper_C7sdev_rec$row_1, "%", miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hyper_C7sdev_rec$row_2, "%", miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hyper_C7sdev_rec$row_3)
miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hyper_C35sdev <- miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hyper[which(miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hyper$C35_Con_Mval < miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hyper$Mval_3Sdcontrol),]
dim(miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hyper_C35sdev)
miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hyper_C35sdev_rec <- miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hyper_C35sdev[which(miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hyper_C35sdev$C35_Con < 0.2),]
dim(miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hyper_C35sdev_rec)
miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hyper_C35sdev_rec <- data.frame(miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hyper_C35sdev_rec)
miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hyper_C35sdev_rec["rowCpG"] <- paste0(miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hyper_C35sdev_rec$row_1, "%", miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hyper_C35sdev_rec$row_2, "%", miMERGE_myiMBvNorm3re_chrpos_avg_PR_Hyper_C35sdev_rec$row_3)
