...
awk '{print $1"\t"$2-10000"\t"$3+2000"\t"$4"\t"$5}' /home/ankitv/ref_av/hg38_DMRs/Monk_human_ICR_hg38.bed  > Monk_human_ICR_hg38_flankplusminus10000.bed

bedtools intersect -wa -wb -a MERGE_myiCombat3reavg_pos_chr.txt -b Monk_human_ICR_hg38_flankplusminus10000.bed > MERGE_myicomCGbatCG3re_human_ICR_flanked10000.txt


MERGE_myicomCGbatCG3re_human_ICR_flanked10000 <- read.table("MERGE_myicomCGbatCG3re_human_ICR_flanked10000.txt", header = F)
head(MERGE_myicomCGbatCG3re_human_ICR_flanked10000)
dim(MERGE_myicomCGbatCG3re_human_ICR_flanked10000)
head(MERGE_myicomCGbatCG3re_human_ICR_flanked10000)
colnames(MERGE_myicomCGbatCG3re_human_ICR_flanked10000) <- c("chrc","startc","endc","id", colnames(MERGE_myiCombat3reavg_pos_chr[,5:22]),"chr","start","end","DMR", "DMRType")
fi10000comCGdata1 <- MERGE_myicomCGbatCG3re_human_ICR_flanked10000[,c((ncol(MERGE_myicomCGbatCG3re_human_ICR_flanked10000)-1),ncol(MERGE_myicomCGbatCG3re_human_ICR_flanked10000), 1:(ncol(MERGE_myicomCGbatCG3re_human_ICR_flanked10000)-5))]
rownames(fi10000comCGdata1)
colnames(fi10000comCGdata1)
head(fi10000comCGdata1)
dim(fi10000comCGdata1)
fi10000comCGdata2 <- fi10000comCGdata1
head(fi10000comCGdata2)
dim(fi10000comCGdata2)
fi10000comCGdata2_line <- data.frame(fi10000comCGdata2[,-c(2)])
head(fi10000comCGdata2_line)
fi10000comCGdata2_line["Row"] <- paste0(fi10000comCGdata2_line$DMR,"%",fi10000comCGdata2_line$chrc,"%",fi10000comCGdata2_line$startc,"%",fi10000comCGdata2_line$endc,"%",fi10000comCGdata2_line$id)
fi10000comCGdata2_line2 <- fi10000comCGdata2_line
rownames(fi10000comCGdata2_line2) <- fi10000comCGdata2_line2$Row
head(fi10000comCGdata2_line2)
fi10000comCGdata2_line2 <- fi10000comCGdata2_line2[,-c(1:6,24)]
head(fi10000comCGdata2_line2)
fi10000comCGdata2_line2 <- as.matrix(fi10000comCGdata2_line2)
fi10000comCGdata2_line2st <- stack(fi10000comCGdata2_line2)
head(fi10000comCGdata2_line2st)
fi10000comCGdata2_line2st <- data.frame(fi10000comCGdata2_line2st)
fi10000comCGdata2_line2st <- fi10000comCGdata2_line2st[,c(2,1,3)]
colnames(fi10000comCGdata2_line2st) <- c("Group", "Csites", "Value")
head(fi10000comCGdata2_line2st)

#PPEL
fi10000comCGdata2_line2st_PPEL <- fi10000comCGdata2_line2st[grep("PPEL", fi10000comCGdata2_line2st$Csites),]
fi10000comCGdata2_line2st_PPEL.sep <- cSplit(fi10000comCGdata2_line2st_PPEL, "Csites", "%")
ggplot(fi10000comCGdata2_line2st_PPEL.sep, aes(x=as.numeric(Csites_3), y=Value, group=Group))+
  geom_line(aes(color=Group))+
  geom_vline(xintercept = c(39558954, 39559868), colour = "black", linetype="solid")+
  geom_point(aes(color=Group), shape=20)+
  scale_color_manual(values=c("darkgrey","darkgrey","darkgrey","darkgrey","darkgrey","darkgrey","darkgrey","darkgrey","darkgrey","darkgrey","darkgrey","#EC7063","#922B21","#148F77","#48C9B0","#1E8449","#52BE80"))+
  theme_classic()
ggsave("Linechart_fi10000comCGdata2_line2st_PPEL.sep.svg", width=25, height=5, units="cm", dpi=96)

#VTRNA2_1
fi10000comCGdata2_line2st_VTRNA2_1 <- fi10000comCGdata2_line2st[grep("VTRNA2-1", fi10000comCGdata2_line2st$Csites),]
fi10000comCGdata2_line2st_VTRNA2_1.sep <- cSplit(fi10000comCGdata2_line2st_VTRNA2_1, "Csites", "%")
ggplot(fi10000comCGdata2_line2st_VTRNA2_1.sep, aes(x=as.numeric(Csites_3), y=Value, group=Group))+
  geom_line(aes(color=Group))+
  geom_vline(xintercept = c(136079113, 136080956), colour = "black", linetype="solid")+
  geom_point(aes(color=Group), shape=20)+
  scale_color_manual(values=c("darkgrey","darkgrey","darkgrey","darkgrey","darkgrey","darkgrey","darkgrey","darkgrey","darkgrey","darkgrey","darkgrey","#EC7063","#922B21","#148F77","#48C9B0","#1E8449","#52BE80"))+
  theme_classic()
ggsave("Linechart_fi10000comCGdata2_line2st_VTRNA2_1.sep.svg", width=25, height=5, units="cm", dpi=96)

#12000
awk '{print $1"\t"$2-12000"\t"$3+5000"\t"$4"\t"$5}' /home/ankitv/ref_av/hg38_DMRs/Monk_human_ICR_hg38.bed  > Monk_human_ICR_hg38_flankplusminus12000.bed

bedtools intersect -wa -wb -a MERGE_myiCombat3reavg_pos_chr.txt -b Monk_human_ICR_hg38_flankplusminus12000.bed > MERGE_myicomCGbatCG3re_human_ICR_flanked12000.txt


MERGE_myicomCGbatCG3re_human_ICR_flanked12000 <- read.table("MERGE_myicomCGbatCG3re_human_ICR_flanked12000.txt", header = F)
head(MERGE_myicomCGbatCG3re_human_ICR_flanked12000)
dim(MERGE_myicomCGbatCG3re_human_ICR_flanked12000)
head(MERGE_myicomCGbatCG3re_human_ICR_flanked12000)
colnames(MERGE_myicomCGbatCG3re_human_ICR_flanked12000) <- c("chrc","startc","endc","id", colnames(MERGE_myiCombat3reavg_pos_chr[,5:22]),"chr","start","end","DMR", "DMRType")
fi12000comCGdata1 <- MERGE_myicomCGbatCG3re_human_ICR_flanked12000[,c((ncol(MERGE_myicomCGbatCG3re_human_ICR_flanked12000)-1),ncol(MERGE_myicomCGbatCG3re_human_ICR_flanked12000), 1:(ncol(MERGE_myicomCGbatCG3re_human_ICR_flanked12000)-5))]
rownames(fi12000comCGdata1)
colnames(fi12000comCGdata1)
head(fi12000comCGdata1)
dim(fi12000comCGdata1)
fi12000comCGdata2 <- fi12000comCGdata1
head(fi12000comCGdata2)
dim(fi12000comCGdata2)
fi12000comCGdata2_line <- data.frame(fi12000comCGdata2[,-c(2)])
head(fi12000comCGdata2_line)
fi12000comCGdata2_line["Row"] <- paste0(fi12000comCGdata2_line$DMR,"%",fi12000comCGdata2_line$chrc,"%",fi12000comCGdata2_line$startc,"%",fi12000comCGdata2_line$endc,"%",fi12000comCGdata2_line$id)
fi12000comCGdata2_line2 <- fi12000comCGdata2_line
rownames(fi12000comCGdata2_line2) <- fi12000comCGdata2_line2$Row
head(fi12000comCGdata2_line2)
fi12000comCGdata2_line2 <- fi12000comCGdata2_line2[,-c(1:6,24)]
head(fi12000comCGdata2_line2)
fi12000comCGdata2_line2 <- as.matrix(fi12000comCGdata2_line2)
fi12000comCGdata2_line2st <- stack(fi12000comCGdata2_line2)
head(fi12000comCGdata2_line2st)
fi12000comCGdata2_line2st <- data.frame(fi12000comCGdata2_line2st)
fi12000comCGdata2_line2st <- fi12000comCGdata2_line2st[,c(2,1,3)]
colnames(fi12000comCGdata2_line2st) <- c("Group", "Csites", "Value")
head(fi12000comCGdata2_line2st)
...
#ZNF597_tss
fi12000comCGdata2_line2st_ZNF597_tss <- fi12000comCGdata2_line2st[grep("ZNF597_tss", fi12000comCGdata2_line2st$Csites),]
fi12000comCGdata2_line2st_ZNF597_tss.sep <- cSplit(fi12000comCGdata2_line2st_ZNF597_tss, "Csites", "%")
ggplot(fi12000comCGdata2_line2st_ZNF597_tss.sep, aes(x=as.numeric(Csites_3), y=Value, group=Group))+
  geom_line(aes(color=Group))+
  geom_vline(xintercept = c(3442828, 3444463), colour = "black", linetype="solid")+
  geom_point(aes(color=Group), shape=20)+
  scale_color_manual(values=c("darkgrey","darkgrey","darkgrey","darkgrey","darkgrey","darkgrey","darkgrey","darkgrey","darkgrey","darkgrey","darkgrey","#EC7063","#922B21","#148F77","#48C9B0","#1E8449","#52BE80"))+
  theme_classic()
ggsave("Linechart_fi12000comCGdata2_line2st_ZNF597_tss.sep.svg", width=25, height=5, units="cm", dpi=96)
...
# 
# 
# #MKRN3 needs pR before pG so I rerarranged
# MM_PK_Imp_gene_Exp_FPKM_MKRN3 <- MM_PK_Imp_gene_Exp_FPKM[grep("MKRN3", MM_PK_Imp_gene_Exp_FPKM$gene_name),]
# MM_PK_Imp_gene_Exp_FPKM_MKRN3Log <- data.frame(stack(t(MM_PK_Imp_gene_Exp_FPKM_MKRN3[,c(10,14,15,11:13)])))
# 
...
# barplot( height=MM_PK_Imp_gene_Exp_FPKM_MKRN3Log$value, names=MM_PK_Imp_gene_Exp_FPKM_MKRN3Log$row , density=c(12,12,12,12,12,12,12) , angle=c(45,45,45,45,45,45,45) , col=c("darkgrey","#922B21","#148F77","#EC7063","#48C9B0","#52BE80"),xlab = "Samples", ylab = "Log2(FPKM)",main = "MKRN3")
