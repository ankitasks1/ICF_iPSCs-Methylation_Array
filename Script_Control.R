...
#Batch correction for new and old control data
...
#Import MANIFEST (lifted over to hg38)
...
length(intersect(miMERGE_myipubCombat3re_chrpos_avg_PR_Hypo$row_4, miMERGE_myipubCombat3re_chrpos_avg_PG_Hypo$row_4))
length(intersect(miMERGE_myipubCombat3re_chrpos_avg_PR_Hyper$row_4, miMERGE_myipubCombat3re_chrpos_avg_PG_Hyper$row_4))

#Also check the actual diff meth CpGs in corrected clones
library(dplyr)
pMERGE_myipubCombat3re_pos_chravg2_C13dev <- pMERGE_myipubCombat3re_pos_chravg2[which(pMERGE_myipubCombat3re_pos_chravg2$C13_Con_Mval >= pMERGE_myipubCombat3re_pos_chravg2$Mval_3Sdcontrol),]
pMERGE_myipubCombat3re_pos_chravg_C13_Hyper <- pMERGE_myipubCombat3re_pos_chravg2_C13dev[which(pMERGE_myipubCombat3re_pos_chravg2_C13dev$C13_Con > 0.2),]
fpMERGE_myipubCombat3re_pos_chravg_C13_Hyper <- pMERGE_myipubCombat3re_pos_chravg_C13_Hyper %>%
  filter_at(vars(D250_Con:iPSC_control9_Con), all_vars(. < 0.2))

dim(fpMERGE_myipubCombat3re_pos_chravg_C13_Hyper)

pMERGE_myipubCombat3re_pos_chravg2_C50dev <- pMERGE_myipubCombat3re_pos_chravg2[which(pMERGE_myipubCombat3re_pos_chravg2$C50_Con_Mval >= pMERGE_myipubCombat3re_pos_chravg2$Mval_3Sdcontrol),]
pMERGE_myipubCombat3re_pos_chravg_C50_Hyper <- pMERGE_myipubCombat3re_pos_chravg2_C50dev[which(pMERGE_myipubCombat3re_pos_chravg2_C50dev$C50_Con > 0.2),]
fpMERGE_myipubCombat3re_pos_chravg_C50_Hyper <- pMERGE_myipubCombat3re_pos_chravg_C50_Hyper %>%
  filter_at(vars(D250_Con:iPSC_control9_Con), all_vars(. < 0.2))

dim(fpMERGE_myipubCombat3re_pos_chravg_C50_Hyper)

pMERGE_myipubCombat3re_pos_chravg2_C7dev <- pMERGE_myipubCombat3re_pos_chravg2[which(pMERGE_myipubCombat3re_pos_chravg2$C7_Con_Mval >= pMERGE_myipubCombat3re_pos_chravg2$Mval_3Sdcontrol),]
pMERGE_myipubCombat3re_pos_chravg_C7_Hyper <- pMERGE_myipubCombat3re_pos_chravg2_C7dev[which(pMERGE_myipubCombat3re_pos_chravg2_C7dev$C7_Con > 0.2),]
fpMERGE_myipubCombat3re_pos_chravg_C7_Hyper <- pMERGE_myipubCombat3re_pos_chravg_C7_Hyper %>%
  filter_at(vars(D250_Con:iPSC_control9_Con), all_vars(. < 0.2))

dim(fpMERGE_myipubCombat3re_pos_chravg_C7_Hyper)

pMERGE_myipubCombat3re_pos_chravg2_C35dev <- pMERGE_myipubCombat3re_pos_chravg2[which(pMERGE_myipubCombat3re_pos_chravg2$C35_Con_Mval >= pMERGE_myipubCombat3re_pos_chravg2$Mval_3Sdcontrol),]
pMERGE_myipubCombat3re_pos_chravg_C35_Hyper <- pMERGE_myipubCombat3re_pos_chravg2_C35dev[which(pMERGE_myipubCombat3re_pos_chravg2_C35dev$C35_Con > 0.2),]
fpMERGE_myipubCombat3re_pos_chravg_C35_Hyper <- pMERGE_myipubCombat3re_pos_chravg_C35_Hyper %>%
  filter_at(vars(D250_Con:iPSC_control9_Con), all_vars(. < 0.2))

dim(fpMERGE_myipubCombat3re_pos_chravg_C35_Hyper)

pMERGE_myipubCombat3re_pos_chravg2_C13dev <- pMERGE_myipubCombat3re_pos_chravg2[which(pMERGE_myipubCombat3re_pos_chravg2$C13_Con_Mval >= pMERGE_myipubCombat3re_pos_chravg2$Mval_3Sdcontrol),]
pMERGE_myipubCombat3re_pos_chravg_C13_Hypo <- pMERGE_myipubCombat3re_pos_chravg2_C13dev[which(pMERGE_myipubCombat3re_pos_chravg2_C13dev$C13_Con < -0.2),]
fpMERGE_myipubCombat3re_pos_chravg_C13_Hypo <- pMERGE_myipubCombat3re_pos_chravg_C13_Hypo %>%
  filter_at(vars(D250_Con:iPSC_control9_Con), all_vars(. > -0.2))

dim(fpMERGE_myipubCombat3re_pos_chravg_C13_Hypo)

pMERGE_myipubCombat3re_pos_chravg2_C50dev <- pMERGE_myipubCombat3re_pos_chravg2[which(pMERGE_myipubCombat3re_pos_chravg2$C50_Con_Mval >= pMERGE_myipubCombat3re_pos_chravg2$Mval_3Sdcontrol),]
pMERGE_myipubCombat3re_pos_chravg_C50_Hypo <- pMERGE_myipubCombat3re_pos_chravg2_C50dev[which(pMERGE_myipubCombat3re_pos_chravg2_C50dev$C50_Con < -0.2),]
fpMERGE_myipubCombat3re_pos_chravg_C50_Hypo <- pMERGE_myipubCombat3re_pos_chravg_C50_Hypo %>%
  filter_at(vars(D250_Con:iPSC_control9_Con), all_vars(. > -0.2))

dim(fpMERGE_myipubCombat3re_pos_chravg_C50_Hypo)

pMERGE_myipubCombat3re_pos_chravg2_C7dev <- pMERGE_myipubCombat3re_pos_chravg2[which(pMERGE_myipubCombat3re_pos_chravg2$C7_Con_Mval >= pMERGE_myipubCombat3re_pos_chravg2$Mval_3Sdcontrol),]
pMERGE_myipubCombat3re_pos_chravg_C7_Hypo <- pMERGE_myipubCombat3re_pos_chravg2_C7dev[which(pMERGE_myipubCombat3re_pos_chravg2_C7dev$C7_Con < -0.2),]
fpMERGE_myipubCombat3re_pos_chravg_C7_Hypo <- pMERGE_myipubCombat3re_pos_chravg_C7_Hypo %>%
  filter_at(vars(D250_Con:iPSC_control9_Con), all_vars(. > -0.2))

dim(fpMERGE_myipubCombat3re_pos_chravg_C7_Hypo)

pMERGE_myipubCombat3re_pos_chravg2_C35dev <- pMERGE_myipubCombat3re_pos_chravg2[which(pMERGE_myipubCombat3re_pos_chravg2$C35_Con_Mval >= pMERGE_myipubCombat3re_pos_chravg2$Mval_3Sdcontrol),]
pMERGE_myipubCombat3re_pos_chravg_C35_Hypo <- pMERGE_myipubCombat3re_pos_chravg2_C35dev[which(pMERGE_myipubCombat3re_pos_chravg2_C35dev$C35_Con < -0.2),]
fpMERGE_myipubCombat3re_pos_chravg_C35_Hypo <- pMERGE_myipubCombat3re_pos_chravg_C35_Hypo %>%
  filter_at(vars(D250_Con:iPSC_control9_Con), all_vars(. > -0.2))

dim(fpMERGE_myipubCombat3re_pos_chravg_C35_Hypo)
...
miMERGE_myipubCombat3re_chrpos500bp_avg_PG_Hyper_chr_clusteredgene["row"] <- paste0(miMERGE_myipubCombat3re_chrpos500bp_avg_PG_Hyper_chr_clusteredgene$V1,
                                                                                    "%",
                                                                                    miMERGE_myipubCombat3re_chrpos500bp_avg_PG_Hyper_chr_clusteredgene$V2,
                                                                                    "%",
                                                                                    miMERGE_myipubCombat3re_chrpos500bp_avg_PG_Hyper_chr_clusteredgene$V3,
                                                                                    "%",
                                                                                    miMERGE_myipubCombat3re_chrpos500bp_avg_PG_Hyper_chr_clusteredgene$V4)

head(miMERGE_myipubCombat3re_chrpos500bp_avg_PG_Hyper_chr_clusteredgene)
miMERGE_myipubCombat3re_chrpos500bp_avg_PG_Hyper_chr_clusteredgenedis <- ddply(miMERGE_myipubCombat3re_chrpos500bp_avg_PG_Hyper_chr_clusteredgene, .(row), summarize, Gene = toString(V10), Dis = toString(V11))
dim(miMERGE_myipubCombat3re_chrpos500bp_avg_PG_Hyper_chr_clusteredgenedis)
head(miMERGE_myipubCombat3re_chrpos500bp_avg_PG_Hyper_chr_clusteredgenedis)
miMERGE_myipubCombat3re_chrpos500bp_avg_PG_Hyper_chr_clusteredgenedis$Genes <- gsub(" ", "", miMERGE_myipubCombat3re_chrpos500bp_avg_PG_Hyper_chr_clusteredgenedis$Gene)
miMERGE_myipubCombat3re_chrpos500bp_avg_PG_Hyper_chr_clusteredgenedis$Distance <- gsub(" ", "", miMERGE_myipubCombat3re_chrpos500bp_avg_PG_Hyper_chr_clusteredgenedis$Dis)
miMERGE_myipubCombat3re_chrpos500bp_avg_PG_Hyper_chr_clusteredgenedischr <- cSplit(miMERGE_myipubCombat3re_chrpos500bp_avg_PG_Hyper_chr_clusteredgenedis, "row", "%")
head(miMERGE_myipubCombat3re_chrpos500bp_avg_PG_Hyper_chr_clusteredgenedischr)
miMERGE_myipubCombat3re_chrpos500bp_avg_PG_Hyper_chr_clusteredgenedischr <- miMERGE_myipubCombat3re_chrpos500bp_avg_PG_Hyper_chr_clusteredgenedischr[,c(5:8,3,4)]
miMERGE_myipubCombat3re_chrpos500bp_avg_PG_Hyper_chr_clusteredgenedischr <- miMERGE_myipubCombat3re_chrpos500bp_avg_PG_Hyper_chr_clusteredgenedischr[order(-miMERGE_myipubCombat3re_chrpos500bp_avg_PG_Hyper_chr_clusteredgenedischr$row_4),]
head(miMERGE_myipubCombat3re_chrpos500bp_avg_PG_Hyper_chr_clusteredgenedischr,10)
write.table(miMERGE_myipubCombat3re_chrpos500bp_avg_PG_Hyper_chr_clusteredgenedischr, "miMERGE_myipubCombat3re_chrpos500bp_avg_PG_Hyper_chr_clusteredgenedischr.txt", sep="\t", append = F,quote=F, col.names=T, row.names = F)
...
miMERGE_myipubCombat3re_chrpos500bp_avg_PG_Hypo_chr_clusteredgene["row"] <- paste0(miMERGE_myipubCombat3re_chrpos500bp_avg_PG_Hypo_chr_clusteredgene$V1,
                                                                                   "%",
                                                                                   miMERGE_myipubCombat3re_chrpos500bp_avg_PG_Hypo_chr_clusteredgene$V2,
                                                                                   "%",
                                                                                   miMERGE_myipubCombat3re_chrpos500bp_avg_PG_Hypo_chr_clusteredgene$V3,
                                                                                   "%",
                                                                                   miMERGE_myipubCombat3re_chrpos500bp_avg_PG_Hypo_chr_clusteredgene$V4)

head(miMERGE_myipubCombat3re_chrpos500bp_avg_PG_Hypo_chr_clusteredgene)
miMERGE_myipubCombat3re_chrpos500bp_avg_PG_Hypo_chr_clusteredgenedis <- ddply(miMERGE_myipubCombat3re_chrpos500bp_avg_PG_Hypo_chr_clusteredgene, .(row), summarize, Gene = toString(V10), Dis = toString(V11))
dim(miMERGE_myipubCombat3re_chrpos500bp_avg_PG_Hypo_chr_clusteredgenedis)
head(miMERGE_myipubCombat3re_chrpos500bp_avg_PG_Hypo_chr_clusteredgenedis)
miMERGE_myipubCombat3re_chrpos500bp_avg_PG_Hypo_chr_clusteredgenedis$Genes <- gsub(" ", "", miMERGE_myipubCombat3re_chrpos500bp_avg_PG_Hypo_chr_clusteredgenedis$Gene)
miMERGE_myipubCombat3re_chrpos500bp_avg_PG_Hypo_chr_clusteredgenedis$Distance <- gsub(" ", "", miMERGE_myipubCombat3re_chrpos500bp_avg_PG_Hypo_chr_clusteredgenedis$Dis)
miMERGE_myipubCombat3re_chrpos500bp_avg_PG_Hypo_chr_clusteredgenedischr <- cSplit(miMERGE_myipubCombat3re_chrpos500bp_avg_PG_Hypo_chr_clusteredgenedis, "row", "%")
head(miMERGE_myipubCombat3re_chrpos500bp_avg_PG_Hypo_chr_clusteredgenedischr)
miMERGE_myipubCombat3re_chrpos500bp_avg_PG_Hypo_chr_clusteredgenedischr <- miMERGE_myipubCombat3re_chrpos500bp_avg_PG_Hypo_chr_clusteredgenedischr[,c(5:8,3,4)]
miMERGE_myipubCombat3re_chrpos500bp_avg_PG_Hypo_chr_clusteredgenedischr <- miMERGE_myipubCombat3re_chrpos500bp_avg_PG_Hypo_chr_clusteredgenedischr[order(-miMERGE_myipubCombat3re_chrpos500bp_avg_PG_Hypo_chr_clusteredgenedischr$row_4),]
head(miMERGE_myipubCombat3re_chrpos500bp_avg_PG_Hypo_chr_clusteredgenedischr,10)
write.table(miMERGE_myipubCombat3re_chrpos500bp_avg_PG_Hypo_chr_clusteredgenedischr, "miMERGE_myipubCombat3re_chrpos500bp_avg_PG_Hypo_chr_clusteredgenedischr.txt", sep="\t", append = F,quote=F, col.names=T, row.names = F)
...
miMERGE_myipubCombat3re_chrpos500bp_avg_PR_Hyper_chr_clusteredgene["row"] <- paste0(miMERGE_myipubCombat3re_chrpos500bp_avg_PR_Hyper_chr_clusteredgene$V1,
                                                                                    "%",
                                                                                    miMERGE_myipubCombat3re_chrpos500bp_avg_PR_Hyper_chr_clusteredgene$V2,
                                                                                    "%",
                                                                                    miMERGE_myipubCombat3re_chrpos500bp_avg_PR_Hyper_chr_clusteredgene$V3,
                                                                                    "%",
                                                                                    miMERGE_myipubCombat3re_chrpos500bp_avg_PR_Hyper_chr_clusteredgene$V4)

head(miMERGE_myipubCombat3re_chrpos500bp_avg_PR_Hyper_chr_clusteredgene)
miMERGE_myipubCombat3re_chrpos500bp_avg_PR_Hyper_chr_clusteredgenedis <- ddply(miMERGE_myipubCombat3re_chrpos500bp_avg_PR_Hyper_chr_clusteredgene, .(row), summarize, Gene = toString(V10), Dis = toString(V11))
dim(miMERGE_myipubCombat3re_chrpos500bp_avg_PR_Hyper_chr_clusteredgenedis)
head(miMERGE_myipubCombat3re_chrpos500bp_avg_PR_Hyper_chr_clusteredgenedis)
miMERGE_myipubCombat3re_chrpos500bp_avg_PR_Hyper_chr_clusteredgenedis$Genes <- gsub(" ", "", miMERGE_myipubCombat3re_chrpos500bp_avg_PR_Hyper_chr_clusteredgenedis$Gene)
miMERGE_myipubCombat3re_chrpos500bp_avg_PR_Hyper_chr_clusteredgenedis$Distance <- gsub(" ", "", miMERGE_myipubCombat3re_chrpos500bp_avg_PR_Hyper_chr_clusteredgenedis$Dis)
miMERGE_myipubCombat3re_chrpos500bp_avg_PR_Hyper_chr_clusteredgenedischr <- cSplit(miMERGE_myipubCombat3re_chrpos500bp_avg_PR_Hyper_chr_clusteredgenedis, "row", "%")
head(miMERGE_myipubCombat3re_chrpos500bp_avg_PR_Hyper_chr_clusteredgenedischr)
miMERGE_myipubCombat3re_chrpos500bp_avg_PR_Hyper_chr_clusteredgenedischr <- miMERGE_myipubCombat3re_chrpos500bp_avg_PR_Hyper_chr_clusteredgenedischr[,c(5:8,3,4)]
miMERGE_myipubCombat3re_chrpos500bp_avg_PR_Hyper_chr_clusteredgenedischr <- miMERGE_myipubCombat3re_chrpos500bp_avg_PR_Hyper_chr_clusteredgenedischr[order(-miMERGE_myipubCombat3re_chrpos500bp_avg_PR_Hyper_chr_clusteredgenedischr$row_4),]
head(miMERGE_myipubCombat3re_chrpos500bp_avg_PR_Hyper_chr_clusteredgenedischr,10)
write.table(miMERGE_myipubCombat3re_chrpos500bp_avg_PR_Hyper_chr_clusteredgenedischr, "miMERGE_myipubCombat3re_chrpos500bp_avg_PR_Hyper_chr_clusteredgenedischr.txt", sep="\t", append = F,quote=F, col.names=T, row.names = F)
...
miMERGE_myipubCombat3re_chrpos500bp_avg_PR_Hypo_chr_clusteredgene["row"] <- paste0(miMERGE_myipubCombat3re_chrpos500bp_avg_PR_Hypo_chr_clusteredgene$V1,
                                                                                   "%",
                                                                                   miMERGE_myipubCombat3re_chrpos500bp_avg_PR_Hypo_chr_clusteredgene$V2,
                                                                                   "%",
                                                                                   miMERGE_myipubCombat3re_chrpos500bp_avg_PR_Hypo_chr_clusteredgene$V3,
                                                                                   "%",
                                                                                   miMERGE_myipubCombat3re_chrpos500bp_avg_PR_Hypo_chr_clusteredgene$V4)

head(miMERGE_myipubCombat3re_chrpos500bp_avg_PR_Hypo_chr_clusteredgene)
miMERGE_myipubCombat3re_chrpos500bp_avg_PR_Hypo_chr_clusteredgenedis <- ddply(miMERGE_myipubCombat3re_chrpos500bp_avg_PR_Hypo_chr_clusteredgene, .(row), summarize, Gene = toString(V10), Dis = toString(V11))
dim(miMERGE_myipubCombat3re_chrpos500bp_avg_PR_Hypo_chr_clusteredgenedis)
head(miMERGE_myipubCombat3re_chrpos500bp_avg_PR_Hypo_chr_clusteredgenedis)
miMERGE_myipubCombat3re_chrpos500bp_avg_PR_Hypo_chr_clusteredgenedis$Genes <- gsub(" ", "", miMERGE_myipubCombat3re_chrpos500bp_avg_PR_Hypo_chr_clusteredgenedis$Gene)
miMERGE_myipubCombat3re_chrpos500bp_avg_PR_Hypo_chr_clusteredgenedis$Distance <- gsub(" ", "", miMERGE_myipubCombat3re_chrpos500bp_avg_PR_Hypo_chr_clusteredgenedis$Dis)
miMERGE_myipubCombat3re_chrpos500bp_avg_PR_Hypo_chr_clusteredgenedischr <- cSplit(miMERGE_myipubCombat3re_chrpos500bp_avg_PR_Hypo_chr_clusteredgenedis, "row", "%")
head(miMERGE_myipubCombat3re_chrpos500bp_avg_PR_Hypo_chr_clusteredgenedischr)
miMERGE_myipubCombat3re_chrpos500bp_avg_PR_Hypo_chr_clusteredgenedischr <- miMERGE_myipubCombat3re_chrpos500bp_avg_PR_Hypo_chr_clusteredgenedischr[,c(5:8,3,4)]
miMERGE_myipubCombat3re_chrpos500bp_avg_PR_Hypo_chr_clusteredgenedischr <- miMERGE_myipubCombat3re_chrpos500bp_avg_PR_Hypo_chr_clusteredgenedischr[order(-miMERGE_myipubCombat3re_chrpos500bp_avg_PR_Hypo_chr_clusteredgenedischr$row_4),]
head(miMERGE_myipubCombat3re_chrpos500bp_avg_PR_Hypo_chr_clusteredgenedischr,10)
write.table(miMERGE_myipubCombat3re_chrpos500bp_avg_PR_Hypo_chr_clusteredgenedischr, "miMERGE_myipubCombat3re_chrpos500bp_avg_PR_Hypo_chr_clusteredgenedischr.txt", sep="\t", append = F,quote=F, col.names=T, row.names = F)
...
#Overlap diff meth 500 bp bins with diff meth CpGs
#Bin500bp_Hyper PG with PG Hyper CpGs
...
#Out of  22 PG hyper 500 bp bins 21 overlapped with hyper CpGs mainly because while calling hyper single CpGs control < 0.2 were considered, 
#So it has happened CpGs with that cutoff were filtered as an individual but not while doing 500bp bins.
...
#Get the shared affected 500bp bins between pG and pR

shared_hypo_hyper_500bp_in_pG_pR <- data.frame(intersect(Re_ipubcomdataBin500bp_Hypo_Hyper_PG_1_filtmin2chr_aggregate$Bin500bp, Re_ipubcomdataBin500bp_Hypo_Hyper_PR_1_filtmin2chr_aggregate$Bin500bp))
colnames(shared_hypo_hyper_500bp_in_pG_pR) <- "Bin500bp"


uniqueTo_hypo_hyper_500bp_in_pG <- data.frame(setdiff(Re_ipubcomdataBin500bp_Hypo_Hyper_PG_1_filtmin2chr_aggregate$Bin500bp, Re_ipubcomdataBin500bp_Hypo_Hyper_PR_1_filtmin2chr_aggregate$Bin500bp))
colnames(uniqueTo_hypo_hyper_500bp_in_pG) <- "Bin500bp"
uniqueTo_hypo_hyper_500bp_in_pR <- data.frame(setdiff(Re_ipubcomdataBin500bp_Hypo_Hyper_PR_1_filtmin2chr_aggregate$Bin500bp, Re_ipubcomdataBin500bp_Hypo_Hyper_PG_1_filtmin2chr_aggregate$Bin500bp))
colnames(uniqueTo_hypo_hyper_500bp_in_pR) <- "Bin500bp"

shared_Re_ipubcomdataBin500bp_Hypo_Hyper_PG_1_filtmin2chr_aggregate <- merge(shared_hypo_hyper_500bp_in_pG_pR, Re_ipubcomdataBin500bp_Hypo_Hyper_PG_1_filtmin2chr_aggregate, by="Bin500bp")
shared_Re_ipubcomdataBin500bp_Hypo_Hyper_PR_1_filtmin2chr_aggregate <- merge(shared_hypo_hyper_500bp_in_pG_pR, Re_ipubcomdataBin500bp_Hypo_Hyper_PR_1_filtmin2chr_aggregate, by="Bin500bp")
nonshared_Re_ipubcomdataBin500bp_Hypo_Hyper_PG_1_filtmin2chr_aggregate <- merge(uniqueTo_hypo_hyper_500bp_in_pG, Re_ipubcomdataBin500bp_Hypo_Hyper_PG_1_filtmin2chr_aggregate, by="Bin500bp")
...
ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_clusteredgene["row"] <- paste0(ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_clusteredgene$V1,
                                                                         "%",
                                                                         ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_clusteredgene$V2,
                                                                         "%",
                                                                         ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_clusteredgene$V3,
                                                                         "%",
                                                                         ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_clusteredgene$V4)

head(ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_clusteredgene)
ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_clusteredgenedis <- ddply(ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_clusteredgene, .(row), summarize, Gene = toString(V10), Dis = toString(V11))
dim(ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_clusteredgenedis)
head(ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_clusteredgenedis)
ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_clusteredgenedis$Genes <- gsub(" ", "", ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_clusteredgenedis$Gene)
ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_clusteredgenedis$Distance <- gsub(" ", "", ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_clusteredgenedis$Dis)
ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_clusteredgenedischr <- cSplit(ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_clusteredgenedis, "row", "%")
head(ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_clusteredgenedischr)
ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_clusteredgenedischr <- ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_clusteredgenedischr[,c(5:8,3,4)]
ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_clusteredgenedischr <- ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_clusteredgenedischr[order(-ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_clusteredgenedischr$row_4),]
head(ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_clusteredgenedischr,10)
write.table(ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_clusteredgenedischr, "ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_clusteredgenedischr.txt", sep="\t", append = F,quote=F, col.names=T, row.names = F)
...
ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_clusteredgene["row"] <- paste0(ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_clusteredgene$V1,
                                                                          "%",
                                                                          ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_clusteredgene$V2,
                                                                          "%",
                                                                          ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_clusteredgene$V3,
                                                                          "%",
                                                                          ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_clusteredgene$V4)

head(ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_clusteredgene)
ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_clusteredgenedis <- ddply(ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_clusteredgene, .(row), summarize, Gene = toString(V10), Dis = toString(V11))
dim(ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_clusteredgenedis)
head(ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_clusteredgenedis)
ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_clusteredgenedis$Genes <- gsub(" ", "", ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_clusteredgenedis$Gene)
ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_clusteredgenedis$Distance <- gsub(" ", "", ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_clusteredgenedis$Dis)
ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_clusteredgenedischr <- cSplit(ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_clusteredgenedis, "row", "%")
head(ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_clusteredgenedischr)
ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_clusteredgenedischr <- ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_clusteredgenedischr[,c(5:8,3,4)]
ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_clusteredgenedischr <- ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_clusteredgenedischr[order(-ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_clusteredgenedischr$row_4),]
head(ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_clusteredgenedischr,10)
write.table(ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_clusteredgenedischr, "ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_clusteredgenedischr.txt", sep="\t", append = F,quote=F, col.names=T, row.names = F)
...
ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_clusteredgene["row"] <- paste0(ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_clusteredgene$V1,
                                                                          "%",
                                                                          ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_clusteredgene$V2,
                                                                          "%",
                                                                          ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_clusteredgene$V3,
                                                                          "%",
                                                                          ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_clusteredgene$V4)

head(ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_clusteredgene)
ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_clusteredgenedis <- ddply(ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_clusteredgene, .(row), summarize, Gene = toString(V10), Dis = toString(V11))
dim(ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_clusteredgenedis)
head(ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_clusteredgenedis)
ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_clusteredgenedis$Genes <- gsub(" ", "", ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_clusteredgenedis$Gene)
ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_clusteredgenedis$Distance <- gsub(" ", "", ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_clusteredgenedis$Dis)
ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_clusteredgenedischr <- cSplit(ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_clusteredgenedis, "row", "%")
head(ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_clusteredgenedischr)
ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_clusteredgenedischr <- ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_clusteredgenedischr[,c(5:8,3,4)]
ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_clusteredgenedischr <- ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_clusteredgenedischr[order(-ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_clusteredgenedischr$row_4),]
head(ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_clusteredgenedischr,10)
write.table(ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_clusteredgenedischr, "ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_clusteredgenedischr.txt", sep="\t", append = F,quote=F, col.names=T, row.names = F)
...
ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_clusteredgene["row"] <- paste0(ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_clusteredgene$V1,
                                                                         "%",
                                                                         ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_clusteredgene$V2,
                                                                         "%",
                                                                         ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_clusteredgene$V3,
                                                                         "%",
                                                                         ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_clusteredgene$V4)

head(ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_clusteredgene)
ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_clusteredgenedis <- ddply(ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_clusteredgene, .(row), summarize, Gene = toString(V10), Dis = toString(V11))
dim(ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_clusteredgenedis)
head(ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_clusteredgenedis)
ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_clusteredgenedis$Genes <- gsub(" ", "", ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_clusteredgenedis$Gene)
ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_clusteredgenedis$Distance <- gsub(" ", "", ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_clusteredgenedis$Dis)
ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_clusteredgenedischr <- cSplit(ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_clusteredgenedis, "row", "%")
head(ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_clusteredgenedischr)
ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_clusteredgenedischr <- ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_clusteredgenedischr[,c(5:8,3,4)]
ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_clusteredgenedischr <- ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_clusteredgenedischr[order(-ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_clusteredgenedischr$row_4),]
head(ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_clusteredgenedischr,10)
write.table(ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_clusteredgenedischr, "ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_clusteredgenedischr.txt", sep="\t", append = F,quote=F, col.names=T, row.names = F)
...
#500bp
#PG, C13, C50
with(ipubcomdataBin500bp_filt1_counted1avg, plot(Allcontrol, PG, pch=21, cex = 0.8, main="Scatter Plot", xlim=c(0,1), ylim=c(0,1),lwd = 1,col="darkgrey", bg="white",ylab="pG (Beta-value)", xlab="Median Controls (Beta-value)", bty = 'n'))
with(nonshared_Re_ipubcomdataBin500bp_Hypo_Hyper_PG_1_filtmin2chr_aggregate, points(Allcontrol, PG, pch=21, cex = 0.8, main="Scatter Plot", xlim=c(0,1), ylim=c(0,1),lwd = 2,col="#EC7063", bg="white",ylab="pG (Beta-value)", xlab="Median Controls (Beta-value)", bty = 'n'))
with(shared_Re_ipubcomdataBin500bp_Hypo_Hyper_PG_1_filtmin2chr_aggregate, points(Allcontrol, PG, pch=21, cex = 0.8, main="Scatter Plot", xlim=c(0,1), ylim=c(0,1),lwd = 1,col="#EC7063", bg="#EC7063",ylab="pG (Beta-value)", xlab="Median Controls (Beta-value)", bty = 'n'))
#abline(lm(PG ~ Allcontrol, data = ipubcomdataBin500bp_filt1_counted1avg), col = "black", lty = 2,lwd=2)
#abline(lm(PG ~ Allcontrol, data = Re_ipubcomdataBin500bp_Hypo_Hyper_PG_1_filtmin2chr_aggregate), col = "blue", lty = 2,lwd=2)
#save as Scatter_Bin500bp_Re_Hypo_Hyper_PG.svg

with(ipubcomdataBin500bp_filt1_counted1avg, plot(Allcontrol, C13, pch=21, cex = 0.8, main="Scatter Plot", xlim=c(0,1), ylim=c(0,1),lwd = 1,col="darkgrey", bg="white",ylab="C13 (Beta-value)", xlab="Median Controls (Beta-value)", bty = 'n'))
with(nonshared_Re_ipubcomdataBin500bp_Hypo_Hyper_PG_1_filtmin2chr_aggregate, points(Allcontrol, C13, pch=21, cex = 0.8, main="Scatter Plot", xlim=c(0,1), ylim=c(0,1),lwd = 2,col="#48C9B0", bg="white",ylab="C13 (Beta-value)", xlab="Median Controls (Beta-value)", bty = 'n'))
with(shared_Re_ipubcomdataBin500bp_Hypo_Hyper_PG_1_filtmin2chr_aggregate, points(Allcontrol, C13, pch=21, cex = 0.8, main="Scatter Plot", xlim=c(0,1), ylim=c(0,1),lwd = 1,col="#48C9B0", bg="#48C9B0",ylab="C13 (Beta-value)", xlab="Median Controls (Beta-value)", bty = 'n'))
#abline(lm(C13 ~ Allcontrol, data = ipubcomdataBin500bp_filt1_counted1avg), col = "black", lty = 2,lwd=2)
#abline(lm(C13 ~ Allcontrol, data = Re_ipubcomdataBin500bp_Hypo_Hyper_PG_1_filtmin2chr_aggregate), col = "blue", lty = 2,lwd=2)
#save as Scatter_Bin500bp_Re_Hypo_Hyper_C13.svg

with(ipubcomdataBin500bp_filt1_counted1avg, plot(Allcontrol, C50, pch=21, cex = 0.8, main="Scatter Plot", xlim=c(0,1), ylim=c(0,1),lwd = 1,col="darkgrey", bg="white",ylab="C50 (Beta-value)", xlab="Median Controls (Beta-value)", bty = 'n'))
with(nonshared_Re_ipubcomdataBin500bp_Hypo_Hyper_PG_1_filtmin2chr_aggregate, points(Allcontrol, C50, pch=21, cex = 0.8, main="Scatter Plot", xlim=c(0,1), ylim=c(0,1),lwd = 2,col="#52BE80", bg="white",ylab="C50 (Beta-value)", xlab="Median Controls (Beta-value)", bty = 'n'))
with(shared_Re_ipubcomdataBin500bp_Hypo_Hyper_PG_1_filtmin2chr_aggregate, points(Allcontrol, C50, pch=21, cex = 0.8, main="Scatter Plot", xlim=c(0,1), ylim=c(0,1),lwd = 1,col="#52BE80", bg="#52BE80",ylab="C50 (Beta-value)", xlab="Median Controls (Beta-value)", bty = 'n'))
#abline(lm(C50 ~ Allcontrol, data = ipubcomdataBin500bp_filt1_counted1avg), col = "black", lty = 2,lwd=2)
#abline(lm(C50 ~ Allcontrol, data = Re_ipubcomdataBin500bp_Hypo_Hyper_PG_1_filtmin2chr_aggregate), col = "blue", lty = 2,lwd=2)
...
with(ipubcomdataBin500bp_filt1_counted1avg, plot(Allcontrol, PR, pch=21, cex = 0.8, main="Scatter Plot", xlim=c(0,1), ylim=c(0,1),lwd = 1,col="darkgrey", bg="white",ylab="pR (Beta-value)", xlab="Median Controls (Beta-value)", bty = 'n'))
with(nonshared_Re_ipubcomdataBin500bp_Hypo_Hyper_PR_1_filtmin2chr_aggregate, points(Allcontrol, PR, pch=21, cex = 0.8, main="Scatter Plot", xlim=c(0,1), ylim=c(0,1),lwd = 2,col="#922B21", bg="white",ylab="PR (Beta-value)", xlab="Median Controls (Beta-value)", bty = 'n'))
with(shared_Re_ipubcomdataBin500bp_Hypo_Hyper_PR_1_filtmin2chr_aggregate, points(Allcontrol, PR, pch=21, cex = 0.8, main="Scatter Plot", xlim=c(0,1), ylim=c(0,1),lwd = 1,col="#922B21", bg="#922B21",ylab="PR (Beta-value)", xlab="Median Controls (Beta-value)", bty = 'n'))
#abline(lm(PR ~ Allcontrol, data = ipubcomdataBin500bp_filt1_counted1avg), col = "black", lty = 2,lwd=2)
#abline(lm(PR ~ Allcontrol, data = Re_ipubcomdataBin500bp_Hypo_Hyper_PR_1_filtmin2chr_aggregate), col = "blue", lty = 2,lwd=2)
#save as Scatter_Bin500bp_Hypo_Hyper_PR.svg

with(ipubcomdataBin500bp_filt1_counted1avg, plot(Allcontrol, C7, pch=21, cex = 0.8, main="Scatter Plot", xlim=c(0,1), ylim=c(0,1),lwd = 1,col="darkgrey", bg="white",ylab="C7 (Beta-value)", xlab="Median Controls (Beta-value)", bty = 'n'))
with(nonshared_Re_ipubcomdataBin500bp_Hypo_Hyper_PR_1_filtmin2chr_aggregate, points(Allcontrol, C7, pch=21, cex = 0.8, main="Scatter Plot", xlim=c(0,1), ylim=c(0,1),lwd = 2,col="#148F77", bg="white",ylab="C7 (Beta-value)", xlab="Median Controls (Beta-value)", bty = 'n'))
with(shared_Re_ipubcomdataBin500bp_Hypo_Hyper_PR_1_filtmin2chr_aggregate, points(Allcontrol, C7, pch=21, cex = 0.8, main="Scatter Plot", xlim=c(0,1), ylim=c(0,1),lwd = 1,col="#148F77", bg="#148F77",ylab="C7 (Beta-value)", xlab="Median Controls (Beta-value)", bty = 'n'))
#abline(lm(C7 ~ Allcontrol, data = ipubcomdataBin500bp_filt1_counted1avg), col = "black", lty = 2,lwd=2)
#abline(lm(C7 ~ Allcontrol, data = Re_ipubcomdataBin500bp_Hypo_Hyper_PR_1_filtmin2chr_aggregate), col = "blue", lty = 2,lwd=2)
#save as Scatter_Bin500bp_Hypo_Hyper_C7.svg

with(ipubcomdataBin500bp_filt1_counted1avg, plot(Allcontrol, C35, pch=21, cex = 0.8, main="Scatter Plot", xlim=c(0,1), ylim=c(0,1),lwd = 1,col="darkgrey", bg="white",ylab="C35 (Beta-value)", xlab="Median Controls (Beta-value)", bty = 'n'))
with(nonshared_Re_ipubcomdataBin500bp_Hypo_Hyper_PR_1_filtmin2chr_aggregate, points(Allcontrol, C35, pch=21, cex = 0.8, main="Scatter Plot", xlim=c(0,1), ylim=c(0,1),lwd = 2,col="#1E8449", bg="white",ylab="C35 (Beta-value)", xlab="Median Controls (Beta-value)", bty = 'n'))
with(shared_Re_ipubcomdataBin500bp_Hypo_Hyper_PR_1_filtmin2chr_aggregate, points(Allcontrol, C35, pch=21, cex = 0.8, main="Scatter Plot", xlim=c(0,1), ylim=c(0,1),lwd = 1,col="#1E8449", bg="#1E8449",ylab="C35 (Beta-value)", xlab="Median Controls (Beta-value)", bty = 'n'))
#abline(lm(C35 ~ Allcontrol, data = ipubcomdataBin500bp_filt1_counted1avg), col = "black", lty = 2,lwd=2)
#abline(lm(C35 ~ Allcontrol, data = Re_ipubcomdataBin500bp_Hypo_Hyper_PR_1_filtmin2chr_aggregate), col = "blue", lty = 2,lwd=2)
#save as Scatter_Bin500bp_Hypo_Hyper_C35.svg

#Summary 
summary(lm(PG ~ Allcontrol, data = ipubcomdataBin500bp_filt1_counted1avg))
summary(lm(PG ~ Allcontrol, data = Re_ipubcomdataBin500bp_Hypo_Hyper_PG_1_filtmin2chr_aggregate))

summary(lm(C13 ~ Allcontrol, data = ipubcomdataBin500bp_filt1_counted1avg))
summary(lm(C13 ~ Allcontrol, data = Re_ipubcomdataBin500bp_Hypo_Hyper_PG_1_filtmin2chr_aggregate))

summary(lm(C50 ~ Allcontrol, data = ipubcomdataBin500bp_filt1_counted1avg))
summary(lm(C50 ~ Allcontrol, data = Re_ipubcomdataBin500bp_Hypo_Hyper_PG_1_filtmin2chr_aggregate))

summary(lm(PR ~ Allcontrol, data = ipubcomdataBin500bp_filt1_counted1avg))
summary(lm(PR ~ Allcontrol, data = Re_ipubcomdataBin500bp_Hypo_Hyper_PR_1_filtmin2chr_aggregate))

summary(lm(C7 ~ Allcontrol, data = ipubcomdataBin500bp_filt1_counted1avg))
summary(lm(C7 ~ Allcontrol, data = Re_ipubcomdataBin500bp_Hypo_Hyper_PR_1_filtmin2chr_aggregate))

summary(lm(C35 ~ Allcontrol, data = ipubcomdataBin500bp_filt1_counted1avg))
summary(lm(C35 ~ Allcontrol, data = Re_ipubcomdataBin500bp_Hypo_Hyper_PR_1_filtmin2chr_aggregate))
...
dim(miMERGE_myipubCombat3re_pos_chravg_PG_Hypo)
head(miMERGE_myipubCombat3re_pos_chravg_PG_Hypo)
miMERGE_myipubCombat3re_pos_chravg_PG_Hypo <- data.frame(miMERGE_myipubCombat3re_pos_chravg_PG_Hypo)
rownames(miMERGE_myipubCombat3re_pos_chravg_PG_Hypo) <- miMERGE_myipubCombat3re_pos_chravg_PG_Hypo$row_4
library(dplyr)
...
dim(miMERGE_myipubCombat3re_pos_chravg_PR_Hypo)
head(miMERGE_myipubCombat3re_pos_chravg_PR_Hypo)
miMERGE_myipubCombat3re_pos_chravg_PR_Hypo <- data.frame(miMERGE_myipubCombat3re_pos_chravg_PR_Hypo)
rownames(miMERGE_myipubCombat3re_pos_chravg_PR_Hypo) <- miMERGE_myipubCombat3re_pos_chravg_PR_Hypo$row_4
...
head(miMERGE_myipubCombat3re_chrpos_avg_PG_pG_imp_Hypo_CpGs)
miMERGE_myipubCombat3re_chrpos_avg_PG_pG_imp_Hypo_CpGs <- data.frame(miMERGE_myipubCombat3re_chrpos_avg_PG_pG_imp_Hypo_CpGs)
rownames(miMERGE_myipubCombat3re_chrpos_avg_PG_pG_imp_Hypo_CpGs) <- miMERGE_myipubCombat3re_chrpos_avg_PG_pG_imp_Hypo_CpGs$row_4
...
head(miMERGE_myipubCombat3re_chrpos_avg_PR_pR_imp_Hypo_CpGs)
miMERGE_myipubCombat3re_chrpos_avg_PR_pR_imp_Hypo_CpGs <- data.frame(miMERGE_myipubCombat3re_chrpos_avg_PR_pR_imp_Hypo_CpGs)
rownames(miMERGE_myipubCombat3re_chrpos_avg_PR_pR_imp_Hypo_CpGs) <- miMERGE_myipubCombat3re_chrpos_avg_PR_pR_imp_Hypo_CpGs$row_4
...
head(miMERGE_myipubCombat3re_chrpos_avg_PG_pG_pcdh_Hypo_CpGs)
miMERGE_myipubCombat3re_chrpos_avg_PG_pG_pcdh_Hypo_CpGs <- data.frame(miMERGE_myipubCombat3re_chrpos_avg_PG_pG_pcdh_Hypo_CpGs)
rownames(miMERGE_myipubCombat3re_chrpos_avg_PG_pG_pcdh_Hypo_CpGs) <- miMERGE_myipubCombat3re_chrpos_avg_PG_pG_pcdh_Hypo_CpGs$row_4
...
head(miMERGE_myipubCombat3re_chrpos_avg_PR_pR_pcdh_Hypo_CpGs)
miMERGE_myipubCombat3re_chrpos_avg_PR_pR_pcdh_Hypo_CpGs <- data.frame(miMERGE_myipubCombat3re_chrpos_avg_PR_pR_pcdh_Hypo_CpGs)
rownames(miMERGE_myipubCombat3re_chrpos_avg_PR_pR_pcdh_Hypo_CpGs) <- miMERGE_myipubCombat3re_chrpos_avg_PR_pR_pcdh_Hypo_CpGs$row_4
...
ggplot(miMean_myipubCombat3re_pos_chravg_PG_Hypo_imp_PCDH, aes(x=col, y=value)) + 
  geom_violin(trim=FALSE, aes(col = col), size = 1.25)+
  geom_boxplot(width=0.1, fill="white", aes(col = col))+
  labs(title="Violin plot pG",x="samples", y = "methylation differences")+
  ylim(-1.2,1.2)+theme(panel.spacing = unit(1.5, "lines"),axis.text.x = element_text(angle = 90), panel.background = element_rect(fill="white", color = "black"))+
  scale_fill_manual(values = rep(c("white", "white", "white"), 3))+
  scale_color_manual(values = rep(c("#EC7063","#48C9B0","#52BE80"),3))+
  facet_wrap(~Color, scale="free") +geom_hline(yintercept=0, linetype="dashed", color = "darkgrey")

ggsave("Violin_miMean_myipubCombat3re_pos_chravg_PG_Hypo_imp_PCDH.svg", width=25*1.25, height=17*1.25, units="cm", dpi=96)
#pR-All
...
ggplot(miMean_myipubCombat3re_pos_chravg_PR_Hypo_imp_PCDH, aes(x=col, y=value)) + 
  geom_violin(trim=FALSE, aes(col = col), size = 1.25)+
  geom_boxplot(width=0.1, fill="white", aes(col = col))+
  labs(title="Violin plot pR",x="samples", y = "methylation differences")+
  ylim(-1.2,1.2)+theme(panel.spacing = unit(1.5, "lines"),axis.text.x = element_text(angle = 90), panel.background = element_rect(fill="white", color = "black"))+
  scale_fill_manual(values = rep(c("white", "white", "white"), 3))+
  scale_color_manual(values = rep(c("#922B21","#148F77","#1E8449"),3))+
  facet_wrap(~Color, scale="free") +geom_hline(yintercept=0, linetype="dashed", color = "darkgrey")

ggsave("Violin_miMean_myipubCombat3re_pos_chravg_PR_Hypo_imp_PCDH.svg", width=25*1.25, height=17*1.25, units="cm", dpi=96)
...
#Apply a python script to assign shape range python Feature_Shape.py
...
#mean methylation levels mean_myipubCombat3re_avg_PG_gen_el_Hyper acroos each genomic elements
...
#Take mean methylation of C13 and C50
...
#For recovery in corrected clones 500bp bins tend to be higher than Hypo ICF cutoff (> -0.2 no upper limit) or 
...
ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_PGsdev <- data.frame(ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr)
ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_PGsdev["Bin500bp"] <- paste0(ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_PGsdev$row_1, "%", ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_PGsdev$row_2, "%", ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_PGsdev$row_3)

#ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_C13sdev <- ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr[which(ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr$C13_Con_Mval < ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr$Mval_3Sdcontrol),]
#dim(ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_C13sdev)
ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_C13sdev_rec <- ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr[which(ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr$C13_Con > -0.2),]
dim(ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_C13sdev_rec)
ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_C13sdev_rec <- data.frame(ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_C13sdev_rec)
ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_C13sdev_rec["Bin500bp"] <- paste0(ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_C13sdev_rec$row_1, "%", ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_C13sdev_rec$row_2, "%", ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_C13sdev_rec$row_3)

#ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_C50sdev <- ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr[which(ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr$C50_Con_Mval < ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr$Mval_3Sdcontrol),]
#dim(ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_C50sdev)
ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_C50sdev_rec <- ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr[which(ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr$C50_Con > -0.2),]
dim(ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_C50sdev_rec)
ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_C50sdev_rec <- data.frame(ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_C50sdev_rec)
ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_C50sdev_rec["Bin500bp"] <- paste0(ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_C50sdev_rec$row_1, "%", ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_C50sdev_rec$row_2, "%", ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_C50sdev_rec$row_3)


ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_PRsdev <- data.frame(ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr)
ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_PRsdev["Bin500bp"] <- paste0(ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_PRsdev$row_1, "%", ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_PRsdev$row_2, "%", ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_PRsdev$row_3)

#ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_C7sdev <- ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr[which(ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr$C7_Con_Mval < ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr$Mval_3Sdcontrol),]
#dim(ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_C7sdev)
ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_C7sdev_rec <- ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr[which(ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr$C7_Con > -0.2),]
dim(ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_C7sdev_rec)
ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_C7sdev_rec <- data.frame(ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_C7sdev_rec)
ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_C7sdev_rec["Bin500bp"] <- paste0(ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_C7sdev_rec$row_1, "%", ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_C7sdev_rec$row_2, "%", ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_C7sdev_rec$row_3)

#ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_C35sdev <- ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr[which(ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr$C35_Con_Mval < ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr$Mval_3Sdcontrol),]
#dim(ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_C35sdev)
ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_C35sdev_rec <- ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr[which(ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr$C35_Con > -0.2),]
dim(ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_C35sdev_rec)
ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_C35sdev_rec <- data.frame(ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_C35sdev_rec)
ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_C35sdev_rec["Bin500bp"] <- paste0(ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_C35sdev_rec$row_1, "%", ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_C35sdev_rec$row_2, "%", ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_C35sdev_rec$row_3)


ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_PGsdev <- data.frame(ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr)
ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_PGsdev["Bin500bp"] <- paste0(ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_PGsdev$row_1, "%", ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_PGsdev$row_2, "%", ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_PGsdev$row_3)

#ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_C13sdev <- ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr[which(ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr$C13_Con_Mval < ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr$Mval_3Sdcontrol),]
#dim(ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_C13sdev)
ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_C13sdev_rec <- ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr[which(ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr$C13_Con < 0.2),]
dim(ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_C13sdev_rec)
ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_C13sdev_rec <- data.frame(ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_C13sdev_rec)
ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_C13sdev_rec["Bin500bp"] <- paste0(ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_C13sdev_rec$row_1, "%", ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_C13sdev_rec$row_2, "%", ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_C13sdev_rec$row_3)

#ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_C50sdev <- ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr[which(ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr$C50_Con_Mval < ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr$Mval_3Sdcontrol),]
#dim(ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_C50sdev)
ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_C50sdev_rec <- ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr[which(ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr$C50_Con < 0.2),]
dim(ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_C50sdev_rec)
ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_C50sdev_rec <- data.frame(ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_C50sdev_rec)
ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_C50sdev_rec["Bin500bp"] <- paste0(ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_C50sdev_rec$row_1, "%", ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_C50sdev_rec$row_2, "%", ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_C50sdev_rec$row_3)


ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_PRsdev <- data.frame(ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr)
ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_PRsdev["Bin500bp"] <- paste0(ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_PRsdev$row_1, "%", ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_PRsdev$row_2, "%", ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_PRsdev$row_3)

#ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_C7sdev <- ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr[which(ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr$C7_Con_Mval < ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr$Mval_3Sdcontrol),]
#dim(ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_C7sdev)
ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_C7sdev_rec <- ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr[which(ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr$C7_Con < 0.2),]
dim(ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_C7sdev_rec)
ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_C7sdev_rec <- data.frame(ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_C7sdev_rec)
ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_C7sdev_rec["Bin500bp"] <- paste0(ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_C7sdev_rec$row_1, "%", ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_C7sdev_rec$row_2, "%", ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_C7sdev_rec$row_3)

#ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_C35sdev <- ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr[which(ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr$C35_Con_Mval < ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr$Mval_3Sdcontrol),]
#dim(ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_C35sdev)
ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_C35sdev_rec <- ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr[which(ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr$C35_Con < 0.2),]
dim(ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_C35sdev_rec)
ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_C35sdev_rec <- data.frame(ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_C35sdev_rec)
ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_C35sdev_rec["Bin500bp"] <- paste0(ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_C35sdev_rec$row_1, "%", ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_C35sdev_rec$row_2, "%", ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_C35sdev_rec$row_3)


ipubcomdataBin500bp_Hypo_Hyper_PG_1_filtmin2chr_PGsdev <- rbind.data.frame(ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_PGsdev, ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_PGsdev)
dim(ipubcomdataBin500bp_Hypo_Hyper_PG_1_filtmin2chr_PGsdev)
ipubcomdataBin500bp_Hypo_Hyper_PG_1_filtmin2chr_C13sdev_rec <- rbind.data.frame(ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_C13sdev_rec, ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_C13sdev_rec)
dim(ipubcomdataBin500bp_Hypo_Hyper_PG_1_filtmin2chr_C13sdev_rec)
ipubcomdataBin500bp_Hypo_Hyper_PG_1_filtmin2chr_C50sdev_rec <- rbind.data.frame(ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_C50sdev_rec, ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_C50sdev_rec)
dim(ipubcomdataBin500bp_Hypo_Hyper_PG_1_filtmin2chr_C50sdev_rec)

ipubcomdataBin500bp_Hypo_Hyper_PR_1_filtmin2chr_PRsdev <- rbind.data.frame(ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_PRsdev, ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_PRsdev)
dim(ipubcomdataBin500bp_Hypo_Hyper_PR_1_filtmin2chr_PRsdev)
ipubcomdataBin500bp_Hypo_Hyper_PR_1_filtmin2chr_C7sdev_rec <- rbind.data.frame(ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_C7sdev_rec, ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_C7sdev_rec)
dim(ipubcomdataBin500bp_Hypo_Hyper_PR_1_filtmin2chr_C7sdev_rec)
ipubcomdataBin500bp_Hypo_Hyper_PR_1_filtmin2chr_C35sdev_rec <- rbind.data.frame(ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_C35sdev_rec, ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_C35sdev_rec)
dim(ipubcomdataBin500bp_Hypo_Hyper_PR_1_filtmin2chr_C35sdev_rec)

affected_500bp_bins_pGpR <- intersect(ipubcomdataBin500bp_Hypo_Hyper_PG_1_filtmin2chr_PGsdev$Bin500bp, 
                                      ipubcomdataBin500bp_Hypo_Hyper_PR_1_filtmin2chr_PRsdev$Bin500bp)

recovered_500bp_bins_c7c13c35c50 <- intersect(intersect(intersect(ipubcomdataBin500bp_Hypo_Hyper_PG_1_filtmin2chr_C13sdev_rec$Bin500bp, 
                                                                  ipubcomdataBin500bp_Hypo_Hyper_PG_1_filtmin2chr_C50sdev_rec$Bin500bp),
                                                        ipubcomdataBin500bp_Hypo_Hyper_PR_1_filtmin2chr_C7sdev_rec$Bin500bp),
                                              ipubcomdataBin500bp_Hypo_Hyper_PR_1_filtmin2chr_C35sdev_rec$Bin500bp)


recovered_500bp_bins_c7c35 <- intersect(ipubcomdataBin500bp_Hypo_Hyper_PR_1_filtmin2chr_C7sdev_rec$Bin500bp,
                                        ipubcomdataBin500bp_Hypo_Hyper_PR_1_filtmin2chr_C35sdev_rec$Bin500bp)
recovered_500bp_bins_c13c50 <- intersect(ipubcomdataBin500bp_Hypo_Hyper_PG_1_filtmin2chr_C13sdev_rec$Bin500bp,
                                         ipubcomdataBin500bp_Hypo_Hyper_PG_1_filtmin2chr_C50sdev_rec$Bin500bp)

intersect(affected_500bp_bins_pGpR, recovered_500bp_bins_c7c13c35c50)
length(recovered_500bp_bins_c7c13c35c50) * 100/ length(affected_500bp_bins_pGpR)
length(recovered_500bp_bins_c7c35) * 100/ length(ipubcomdataBin500bp_Hypo_Hyper_PR_1_filtmin2chr_PRsdev$Bin500bp)
length(recovered_500bp_bins_c13c50) * 100/ length(ipubcomdataBin500bp_Hypo_Hyper_PG_1_filtmin2chr_PGsdev$Bin500bp)

unique_Bin500bp_PG_not_rec <- data.frame(Bin500bp=setdiff(ipubcomdataBin500bp_Hypo_Hyper_PG_1_filtmin2chr_PGsdev$Bin500bp,union(ipubcomdataBin500bp_Hypo_Hyper_PG_1_filtmin2chr_C13sdev_rec$Bin500bp,ipubcomdataBin500bp_Hypo_Hyper_PG_1_filtmin2chr_C50sdev_rec$Bin500bp)))
unique_Bin500bp_PG_not_recov <- cSplit(unique_Bin500bp_PG_not_rec,"Bin500bp","%")
write.table(unique_Bin500bp_PG_not_recov,"unique_Bin500bp_PG_not_rec.txt", quote = F, append = F,sep="\t", row.names = F,col.names = F)

present_C13_C50_not_PG_Bin500bp_rec <- data.frame(Bin500bp=union(ipubcomdataBin500bp_Hypo_Hyper_PG_1_filtmin2chr_C13sdev_rec$Bin500bp,ipubcomdataBin500bp_Hypo_Hyper_PG_1_filtmin2chr_C50sdev_rec$Bin500bp))
present_C13_C50_not_PG_Bin500bp_recov <- cSplit(present_C13_C50_not_PG_Bin500bp_rec,"Bin500bp","%")
write.table(present_C13_C50_not_PG_Bin500bp_recov,"present_C13_C50_not_PG_Bin500bp_rec.txt", quote = F, append = F,sep="\t", row.names = F,col.names = F)

unique_Bin500bp_PR_not_rec <- data.frame(Bin500bp=setdiff(ipubcomdataBin500bp_Hypo_Hyper_PR_1_filtmin2chr_PRsdev$Bin500bp,union(ipubcomdataBin500bp_Hypo_Hyper_PR_1_filtmin2chr_C7sdev_rec$Bin500bp,ipubcomdataBin500bp_Hypo_Hyper_PR_1_filtmin2chr_C35sdev_rec$Bin500bp)))
unique_Bin500bp_PR_not_recov <- cSplit(unique_Bin500bp_PR_not_rec,"Bin500bp","%")
write.table(unique_Bin500bp_PR_not_recov,"unique_Bin500bp_PR_not_rec.txt", quote = F, append = F,sep="\t", row.names = F,col.names = F)

present_C7_C35_not_PR_Bin500bp_rec <- data.frame(Bin500bp=union(ipubcomdataBin500bp_Hypo_Hyper_PR_1_filtmin2chr_C7sdev_rec$Bin500bp,ipubcomdataBin500bp_Hypo_Hyper_PR_1_filtmin2chr_C35sdev_rec$Bin500bp))
present_C7_C35_not_PR_Bin500bp_recov <- cSplit(present_C7_C35_not_PR_Bin500bp_rec,"Bin500bp","%")
write.table(present_C7_C35_not_PR_Bin500bp_recov,"present_C7_C35_not_PR_Bin500bp_rec.txt", quote = F, append = F,sep="\t", row.names = F,col.names = F)

vennlistpGc13c50 <- list(pG = ipubcomdataBin500bp_Hypo_Hyper_PG_1_filtmin2chr_PGsdev$Bin500bp,
                         cG13 = ipubcomdataBin500bp_Hypo_Hyper_PG_1_filtmin2chr_C13sdev_rec$Bin500bp,
                         cG50 = ipubcomdataBin500bp_Hypo_Hyper_PG_1_filtmin2chr_C50sdev_rec$Bin500bp)

vennlistpRc7c35 <- list(pR = ipubcomdataBin500bp_Hypo_Hyper_PR_1_filtmin2chr_PRsdev$Bin500bp,
                        cR7 = ipubcomdataBin500bp_Hypo_Hyper_PR_1_filtmin2chr_C7sdev_rec$Bin500bp,
                        cR35 = ipubcomdataBin500bp_Hypo_Hyper_PR_1_filtmin2chr_C35sdev_rec$Bin500bp)
library(ggvenn)
ggvenn(
  vennlistpGc13c50, 
  fill_color = c("#EC7063","#48C9B0","#52BE80"),
  stroke_size = 0.5, set_name_size = 3
)
#Pie chart(color got from upoading image to https://html-color-codes.info/colors-from-image/#)
pie(c(128,20,146,646), col = c("#F5B7B0", "#78886F","#9EC0B0","#78BF98"),labels = c("non_recov", "recov_cG50","recov_cG13","recov_cG13_cG50"))
#pie_chart_pGc13c50.svg
#vennlistpGc13c50.png


ggvenn(
  vennlistpRc7c35, 
  fill_color = c("#922B21","#148F77","#1E8449"),
  stroke_size = 0.5, set_name_size = 3
)
#vennlistpRc7c35.png
#Pie chart
pie(c(94,14,228,949), col = c("#C8948F", "#738C6B","#6E9282","#468B65"),labels = c("non_recov", "recov_cR35","recov_cR7","recov_cR7_cR35"))
#pie_chart_pRc7c35.svg
#For recovery in corrected clones single CpGs tend to be higher than Hypo ICF cutoff (> -0.2 no upper limit) or 
...
miMERGE_myipubCombat3re_chrpos_avg_PG_Hypo_PGsdev <- data.frame(miMERGE_myipubCombat3re_chrpos_avg_PG_Hypo)
miMERGE_myipubCombat3re_chrpos_avg_PG_Hypo_PGsdev["rowCpG"] <- paste0(miMERGE_myipubCombat3re_chrpos_avg_PG_Hypo_PGsdev$row_1, "%", miMERGE_myipubCombat3re_chrpos_avg_PG_Hypo_PGsdev$row_2, "%", miMERGE_myipubCombat3re_chrpos_avg_PG_Hypo_PGsdev$row_3)
dim(miMERGE_myipubCombat3re_chrpos_avg_PG_Hypo_PGsdev)
#miMERGE_myipubCombat3re_chrpos_avg_PG_Hypo_C13sdev <- miMERGE_myipubCombat3re_chrpos_avg_PG_Hypo[which(miMERGE_myipubCombat3re_chrpos_avg_PG_Hypo$C13_Con_Mval < miMERGE_myipubCombat3re_chrpos_avg_PG_Hypo$Mval_3Sdcontrol),]
#dim(miMERGE_myipubCombat3re_chrpos_avg_PG_Hypo_C13sdev)
miMERGE_myipubCombat3re_chrpos_avg_PG_Hypo_C13sdev_rec <- miMERGE_myipubCombat3re_chrpos_avg_PG_Hypo[which(miMERGE_myipubCombat3re_chrpos_avg_PG_Hypo$C13_Con > -0.2),]
dim(miMERGE_myipubCombat3re_chrpos_avg_PG_Hypo_C13sdev_rec)
miMERGE_myipubCombat3re_chrpos_avg_PG_Hypo_C13sdev_rec <- data.frame(miMERGE_myipubCombat3re_chrpos_avg_PG_Hypo_C13sdev_rec)
miMERGE_myipubCombat3re_chrpos_avg_PG_Hypo_C13sdev_rec["rowCpG"] <- paste0(miMERGE_myipubCombat3re_chrpos_avg_PG_Hypo_C13sdev_rec$row_1, "%", miMERGE_myipubCombat3re_chrpos_avg_PG_Hypo_C13sdev_rec$row_2, "%", miMERGE_myipubCombat3re_chrpos_avg_PG_Hypo_C13sdev_rec$row_3)

#miMERGE_myipubCombat3re_chrpos_avg_PG_Hypo_C50sdev <- miMERGE_myipubCombat3re_chrpos_avg_PG_Hypo[which(miMERGE_myipubCombat3re_chrpos_avg_PG_Hypo$C50_Con_Mval < miMERGE_myipubCombat3re_chrpos_avg_PG_Hypo$Mval_3Sdcontrol),]
#dim(miMERGE_myipubCombat3re_chrpos_avg_PG_Hypo_C50sdev)
miMERGE_myipubCombat3re_chrpos_avg_PG_Hypo_C50sdev_rec <- miMERGE_myipubCombat3re_chrpos_avg_PG_Hypo[which(miMERGE_myipubCombat3re_chrpos_avg_PG_Hypo$C50_Con > -0.2),]
dim(miMERGE_myipubCombat3re_chrpos_avg_PG_Hypo_C50sdev_rec)
miMERGE_myipubCombat3re_chrpos_avg_PG_Hypo_C50sdev_rec <- data.frame(miMERGE_myipubCombat3re_chrpos_avg_PG_Hypo_C50sdev_rec)
miMERGE_myipubCombat3re_chrpos_avg_PG_Hypo_C50sdev_rec["rowCpG"] <- paste0(miMERGE_myipubCombat3re_chrpos_avg_PG_Hypo_C50sdev_rec$row_1, "%", miMERGE_myipubCombat3re_chrpos_avg_PG_Hypo_C50sdev_rec$row_2, "%", miMERGE_myipubCombat3re_chrpos_avg_PG_Hypo_C50sdev_rec$row_3)


miMERGE_myipubCombat3re_chrpos_avg_PR_Hypo_PRsdev <- data.frame(miMERGE_myipubCombat3re_chrpos_avg_PR_Hypo)
miMERGE_myipubCombat3re_chrpos_avg_PR_Hypo_PRsdev["rowCpG"] <- paste0(miMERGE_myipubCombat3re_chrpos_avg_PR_Hypo_PRsdev$row_1, "%", miMERGE_myipubCombat3re_chrpos_avg_PR_Hypo_PRsdev$row_2, "%", miMERGE_myipubCombat3re_chrpos_avg_PR_Hypo_PRsdev$row_3)
dim(miMERGE_myipubCombat3re_chrpos_avg_PR_Hypo_PRsdev)
#miMERGE_myipubCombat3re_chrpos_avg_PR_Hypo_C7sdev <- miMERGE_myipubCombat3re_chrpos_avg_PR_Hypo[which(miMERGE_myipubCombat3re_chrpos_avg_PR_Hypo$C7_Con_Mval < miMERGE_myipubCombat3re_chrpos_avg_PR_Hypo$Mval_3Sdcontrol),]
#dim(miMERGE_myipubCombat3re_chrpos_avg_PR_Hypo_C7sdev)
miMERGE_myipubCombat3re_chrpos_avg_PR_Hypo_C7sdev_rec <- miMERGE_myipubCombat3re_chrpos_avg_PR_Hypo[which(miMERGE_myipubCombat3re_chrpos_avg_PR_Hypo$C7_Con > -0.2),]
dim(miMERGE_myipubCombat3re_chrpos_avg_PR_Hypo_C7sdev_rec)
miMERGE_myipubCombat3re_chrpos_avg_PR_Hypo_C7sdev_rec <- data.frame(miMERGE_myipubCombat3re_chrpos_avg_PR_Hypo_C7sdev_rec)
miMERGE_myipubCombat3re_chrpos_avg_PR_Hypo_C7sdev_rec["rowCpG"] <- paste0(miMERGE_myipubCombat3re_chrpos_avg_PR_Hypo_C7sdev_rec$row_1, "%", miMERGE_myipubCombat3re_chrpos_avg_PR_Hypo_C7sdev_rec$row_2, "%", miMERGE_myipubCombat3re_chrpos_avg_PR_Hypo_C7sdev_rec$row_3)

#miMERGE_myipubCombat3re_chrpos_avg_PR_Hypo_C35sdev <- miMERGE_myipubCombat3re_chrpos_avg_PR_Hypo[which(miMERGE_myipubCombat3re_chrpos_avg_PR_Hypo$C35_Con_Mval < miMERGE_myipubCombat3re_chrpos_avg_PR_Hypo$Mval_3Sdcontrol),]
#dim(miMERGE_myipubCombat3re_chrpos_avg_PR_Hypo_C35sdev)
miMERGE_myipubCombat3re_chrpos_avg_PR_Hypo_C35sdev_rec <- miMERGE_myipubCombat3re_chrpos_avg_PR_Hypo[which(miMERGE_myipubCombat3re_chrpos_avg_PR_Hypo$C35_Con > -0.2),]
dim(miMERGE_myipubCombat3re_chrpos_avg_PR_Hypo_C35sdev_rec)
miMERGE_myipubCombat3re_chrpos_avg_PR_Hypo_C35sdev_rec <- data.frame(miMERGE_myipubCombat3re_chrpos_avg_PR_Hypo_C35sdev_rec)
miMERGE_myipubCombat3re_chrpos_avg_PR_Hypo_C35sdev_rec["rowCpG"] <- paste0(miMERGE_myipubCombat3re_chrpos_avg_PR_Hypo_C35sdev_rec$row_1, "%", miMERGE_myipubCombat3re_chrpos_avg_PR_Hypo_C35sdev_rec$row_2, "%", miMERGE_myipubCombat3re_chrpos_avg_PR_Hypo_C35sdev_rec$row_3)


miMERGE_myipubCombat3re_chrpos_avg_PG_Hyper_PGsdev <- data.frame(miMERGE_myipubCombat3re_chrpos_avg_PG_Hyper)
miMERGE_myipubCombat3re_chrpos_avg_PG_Hyper_PGsdev["rowCpG"] <- paste0(miMERGE_myipubCombat3re_chrpos_avg_PG_Hyper_PGsdev$row_1, "%", miMERGE_myipubCombat3re_chrpos_avg_PG_Hyper_PGsdev$row_2, "%", miMERGE_myipubCombat3re_chrpos_avg_PG_Hyper_PGsdev$row_3)

#miMERGE_myipubCombat3re_chrpos_avg_PG_Hyper_C13sdev <- miMERGE_myipubCombat3re_chrpos_avg_PG_Hyper[which(miMERGE_myipubCombat3re_chrpos_avg_PG_Hyper$C13_Con_Mval < miMERGE_myipubCombat3re_chrpos_avg_PG_Hyper$Mval_3Sdcontrol),]
#dim(miMERGE_myipubCombat3re_chrpos_avg_PG_Hyper_C13sdev)

miMERGE_myipubCombat3re_chrpos_avg_PG_Hyper_C13sdev_rec <- miMERGE_myipubCombat3re_chrpos_avg_PG_Hyper[which(miMERGE_myipubCombat3re_chrpos_avg_PG_Hyper$C13_Con < 0.2),]
dim(miMERGE_myipubCombat3re_chrpos_avg_PG_Hyper_C13sdev_rec)
miMERGE_myipubCombat3re_chrpos_avg_PG_Hyper_C13sdev_rec <- data.frame(miMERGE_myipubCombat3re_chrpos_avg_PG_Hyper_C13sdev_rec)
miMERGE_myipubCombat3re_chrpos_avg_PG_Hyper_C13sdev_rec["rowCpG"] <- paste0(miMERGE_myipubCombat3re_chrpos_avg_PG_Hyper_C13sdev_rec$row_1, "%", miMERGE_myipubCombat3re_chrpos_avg_PG_Hyper_C13sdev_rec$row_2, "%", miMERGE_myipubCombat3re_chrpos_avg_PG_Hyper_C13sdev_rec$row_3)

#miMERGE_myipubCombat3re_chrpos_avg_PG_Hyper_C50sdev <- miMERGE_myipubCombat3re_chrpos_avg_PG_Hyper[which(miMERGE_myipubCombat3re_chrpos_avg_PG_Hyper$C50_Con_Mval < miMERGE_myipubCombat3re_chrpos_avg_PG_Hyper$Mval_3Sdcontrol),]
#dim(miMERGE_myipubCombat3re_chrpos_avg_PG_Hyper_C50sdev)
miMERGE_myipubCombat3re_chrpos_avg_PG_Hyper_C50sdev_rec <- miMERGE_myipubCombat3re_chrpos_avg_PG_Hyper[which(miMERGE_myipubCombat3re_chrpos_avg_PG_Hyper$C50_Con < 0.2),]
dim(miMERGE_myipubCombat3re_chrpos_avg_PG_Hyper_C50sdev_rec)
miMERGE_myipubCombat3re_chrpos_avg_PG_Hyper_C50sdev_rec <- data.frame(miMERGE_myipubCombat3re_chrpos_avg_PG_Hyper_C50sdev_rec)
miMERGE_myipubCombat3re_chrpos_avg_PG_Hyper_C50sdev_rec["rowCpG"] <- paste0(miMERGE_myipubCombat3re_chrpos_avg_PG_Hyper_C50sdev_rec$row_1, "%", miMERGE_myipubCombat3re_chrpos_avg_PG_Hyper_C50sdev_rec$row_2, "%", miMERGE_myipubCombat3re_chrpos_avg_PG_Hyper_C50sdev_rec$row_3)


miMERGE_myipubCombat3re_chrpos_avg_PR_Hyper_PRsdev <- data.frame(miMERGE_myipubCombat3re_chrpos_avg_PR_Hyper)
miMERGE_myipubCombat3re_chrpos_avg_PR_Hyper_PRsdev["rowCpG"] <- paste0(miMERGE_myipubCombat3re_chrpos_avg_PR_Hyper_PRsdev$row_1, "%", miMERGE_myipubCombat3re_chrpos_avg_PR_Hyper_PRsdev$row_2, "%", miMERGE_myipubCombat3re_chrpos_avg_PR_Hyper_PRsdev$row_3)

#miMERGE_myipubCombat3re_chrpos_avg_PR_Hyper_C7sdev <- miMERGE_myipubCombat3re_chrpos_avg_PR_Hyper[which(miMERGE_myipubCombat3re_chrpos_avg_PR_Hyper$C7_Con_Mval < miMERGE_myipubCombat3re_chrpos_avg_PR_Hyper$Mval_3Sdcontrol),]
#dim(miMERGE_myipubCombat3re_chrpos_avg_PR_Hyper_C7sdev)
miMERGE_myipubCombat3re_chrpos_avg_PR_Hyper_C7sdev_rec <- miMERGE_myipubCombat3re_chrpos_avg_PR_Hyper[which(miMERGE_myipubCombat3re_chrpos_avg_PR_Hyper$C7_Con < 0.2),]
dim(miMERGE_myipubCombat3re_chrpos_avg_PR_Hyper_C7sdev_rec)
miMERGE_myipubCombat3re_chrpos_avg_PR_Hyper_C7sdev_rec <- data.frame(miMERGE_myipubCombat3re_chrpos_avg_PR_Hyper_C7sdev_rec)
miMERGE_myipubCombat3re_chrpos_avg_PR_Hyper_C7sdev_rec["rowCpG"] <- paste0(miMERGE_myipubCombat3re_chrpos_avg_PR_Hyper_C7sdev_rec$row_1, "%", miMERGE_myipubCombat3re_chrpos_avg_PR_Hyper_C7sdev_rec$row_2, "%", miMERGE_myipubCombat3re_chrpos_avg_PR_Hyper_C7sdev_rec$row_3)

#miMERGE_myipubCombat3re_chrpos_avg_PR_Hyper_C35sdev <- miMERGE_myipubCombat3re_chrpos_avg_PR_Hyper[which(miMERGE_myipubCombat3re_chrpos_avg_PR_Hyper$C35_Con_Mval < miMERGE_myipubCombat3re_chrpos_avg_PR_Hyper$Mval_3Sdcontrol),]
#dim(miMERGE_myipubCombat3re_chrpos_avg_PR_Hyper_C35sdev)
miMERGE_myipubCombat3re_chrpos_avg_PR_Hyper_C35sdev_rec <- miMERGE_myipubCombat3re_chrpos_avg_PR_Hyper[which(miMERGE_myipubCombat3re_chrpos_avg_PR_Hyper$C35_Con < 0.2),]
dim(miMERGE_myipubCombat3re_chrpos_avg_PR_Hyper_C35sdev_rec)
miMERGE_myipubCombat3re_chrpos_avg_PR_Hyper_C35sdev_rec <- data.frame(miMERGE_myipubCombat3re_chrpos_avg_PR_Hyper_C35sdev_rec)
miMERGE_myipubCombat3re_chrpos_avg_PR_Hyper_C35sdev_rec["rowCpG"] <- paste0(miMERGE_myipubCombat3re_chrpos_avg_PR_Hyper_C35sdev_rec$row_1, "%", miMERGE_myipubCombat3re_chrpos_avg_PR_Hyper_C35sdev_rec$row_2, "%", miMERGE_myipubCombat3re_chrpos_avg_PR_Hyper_C35sdev_rec$row_3)

#Get non recovered 500 bp bins
ipubcomdataBin500bp_Hypo_Hyper_PR_1_filtmin2chr_C7sdev_nonrec <- setdiff(ipubcomdataBin500bp_Hypo_Hyper_PR_1_filtmin2chr_PRsdev$Bin500bp, ipubcomdataBin500bp_Hypo_Hyper_PR_1_filtmin2chr_C7sdev_rec$Bin500bp)
ipubcomdataBin500bp_Hypo_Hyper_PG_1_filtmin2chr_C13sdev_nonrec <- setdiff(ipubcomdataBin500bp_Hypo_Hyper_PG_1_filtmin2chr_PGsdev$Bin500bp,ipubcomdataBin500bp_Hypo_Hyper_PG_1_filtmin2chr_C13sdev_rec$Bin500bp)
ipubcomdataBin500bp_Hypo_Hyper_PR_1_filtmin2chr_C35sdev_nonrec <- setdiff(ipubcomdataBin500bp_Hypo_Hyper_PR_1_filtmin2chr_PRsdev$Bin500bp,ipubcomdataBin500bp_Hypo_Hyper_PR_1_filtmin2chr_C35sdev_rec$Bin500bp)
ipubcomdataBin500bp_Hypo_Hyper_PG_1_filtmin2chr_C50sdev_nonrec <- setdiff(ipubcomdataBin500bp_Hypo_Hyper_PG_1_filtmin2chr_PGsdev$Bin500bp,ipubcomdataBin500bp_Hypo_Hyper_PG_1_filtmin2chr_C50sdev_rec$Bin500bp)

length(ipubcomdataBin500bp_Hypo_Hyper_PG_1_filtmin2chr_PGsdev$Bin500bp)
length(ipubcomdataBin500bp_Hypo_Hyper_PR_1_filtmin2chr_PRsdev$Bin500bp)
length(ipubcomdataBin500bp_Hypo_Hyper_PR_1_filtmin2chr_C7sdev_nonrec)
length(ipubcomdataBin500bp_Hypo_Hyper_PG_1_filtmin2chr_C13sdev_nonrec)
length(ipubcomdataBin500bp_Hypo_Hyper_PR_1_filtmin2chr_C35sdev_nonrec)
length(ipubcomdataBin500bp_Hypo_Hyper_PG_1_filtmin2chr_C50sdev_nonrec)

#shared pG and pR =767
#unique pG=940-767=173
#unique pR=1285-767=518
#sum pG + pR+ both=767+518+173
#upset plot sum
(440+424+134+65+64+63+49+47+46+21+20+20+15+12+8+7+7+6+3+3+2+1+1)
#Upset plot
upsetlistICF <- list(pG = ipubcomdataBin500bp_Hypo_Hyper_PG_1_filtmin2chr_PGsdev$Bin500bp,
                     pR = ipubcomdataBin500bp_Hypo_Hyper_PR_1_filtmin2chr_PRsdev$Bin500bp,
                     cR7 = ipubcomdataBin500bp_Hypo_Hyper_PR_1_filtmin2chr_C7sdev_nonrec,
                     cG13 = ipubcomdataBin500bp_Hypo_Hyper_PG_1_filtmin2chr_C13sdev_nonrec,
                     cR35 = ipubcomdataBin500bp_Hypo_Hyper_PR_1_filtmin2chr_C35sdev_nonrec,
                     cG50 = ipubcomdataBin500bp_Hypo_Hyper_PG_1_filtmin2chr_C50sdev_nonrec)

library(UpSetR)
upset(fromList(upsetlistICF), 
      order.by = "freq",
      nsets = 6,
      keep.order = T,
      matrix.color = "gray23", 
      main.bar.color = "gray23",
      sets = c("pG", "pR", "cR7", "cG13", "cR35", "cG50"),
      nintersects = NA,
      decreasing = T)
#upsetlistICF.svg
#Recovery
#PG,C13,C50
#hypo
dim(ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr[which(ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr$C13_Con > -0.2),])[1] * 100 / dim(ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr)[1]
dim(ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr[which(ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr$C50_Con > -0.2),])[1] * 100 / dim(ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr)[1]

#hyper
dim(ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr[which(ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr$C13_Con < 0.2),])[1] * 100 / dim(ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr)[1]
dim(ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr[which(ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr$C50_Con < 0.2),])[1] * 100 / dim(ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr)[1]


(dim(ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr[which(ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr$C13_Con > -0.2),])[1] + dim(ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr[which(ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr$C13_Con < 0.2),])[1]) * 100 / (dim(ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr)[1] + dim(ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr)[1])
(dim(ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr[which(ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr$C50_Con > -0.2),])[1] + dim(ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr[which(ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr$C50_Con < 0.2),])[1]) * 100 / (dim(ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr)[1] + dim(ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr)[1])

#PR, C7,C35
#hypo
dim(ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr[which(ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr$C7_Con > -0.2),])[1] * 100 / dim(ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr)[1]
dim(ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr[which(ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr$C35_Con > -0.2),])[1] * 100 / dim(ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr)[1]

#hyper
dim(ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr[which(ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr$C7_Con < 0.2),])[1] * 100 / dim(ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr)[1]
dim(ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr[which(ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr$C35_Con < 0.2),])[1] * 100 / dim(ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr)[1]


(dim(ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr[which(ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr$C7_Con > -0.2),])[1] + dim(ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr[which(ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr$C7_Con < 0.2),])[1]) * 100 / (dim(ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr)[1] + dim(ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr)[1])
(dim(ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr[which(ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr$C35_Con > -0.2),])[1] + dim(ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr[which(ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr$C35_Con < 0.2),])[1]) * 100 / (dim(ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr)[1] + dim(ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr)[1])

grep PCDH *filtmin2chr_clusteredgenedischr.txt | awk -F':' '{print $2}' | awk -F'\t' '{print $1"\t"$2"\t"$3}' > PCDH_cluster_bins.txt
grep TNXB *filtmin2chr_clusteredgenedischr.txt | awk -F':' '{print $2}' | awk -F'\t' '{print $1"\t"$2"\t"$3}' > TNXB_cluster_bins.txt

#RNA-Seq ICFs
MM_PK_Imp_gene_Exp_UQUA <- read.table("/media/ankitv/Archivio2/ankit/Array21/ICF_RNASeq/MM_PK_log2_uqua_normalised_counts_at_expressed_genes.txt", header = T, stringsAsFactors = F)

head(MM_PK_Imp_gene_Exp_UQUA)

MM_PK_Imp_gene_Exp_FCp <- read.table("/media/ankitv/Archivio2/ankit/Array21/ICF_RNASeq/expressed_imprinted_genes.txt", header = T, stringsAsFactors = F)


MM_PK_Imp_gene_Exp_UQUA_FCp <- merge(MM_PK_Imp_gene_Exp_UQUA, MM_PK_Imp_gene_Exp_FCp, by.x="GeneID", by.y="ENSG", all.y=T)
MM_PK_Imp_gene_Exp_UQUA_FCp <- MM_PK_Imp_gene_Exp_UQUA_FCp[,c(9,1,2:8,10:21)]
MM_PK_Imp_gene_Exp_UQUA_FCp <- MM_PK_Imp_gene_Exp_UQUA_FCp[order(MM_PK_Imp_gene_Exp_UQUA_FCp$Gene_name),]
write.table(MM_PK_Imp_gene_Exp_UQUA_FCp, "/media/ankitv/Archivio2/ankit/Array21/ICF_RNASeq/MM_PK_Imp_gene_Exp_UQUA_FCp.txt", quote = F ,sep="\t", append = F, row.names = F)


MM_PK_Imp_gene_Exp_UQUA_FCp_MEG3 <- MM_PK_Imp_gene_Exp_UQUA_FCp[grep("MEG3", MM_PK_Imp_gene_Exp_UQUA_FCp$Gene_name),]
MM_PK_Imp_gene_Exp_UQUA_FCp_MEG3Log <- data.frame(stack(t(MM_PK_Imp_gene_Exp_UQUA_FCp_MEG3[,3:9])))

ggplot(MM_PK_Imp_gene_Exp_UQUA_FCp_MEG3Log)+
  geom_bar(aes(x=row, y=value, col=row, fill=row),stat = "identity")+
  ggtitle("MEG3")+
  theme_bw()+ scale_color_manual(values=c("darkgrey","red","green","#009A17","darkred","darkgreen","darkgreen"))+ 
  scale_fill_manual(values=c("white","white","white","white","white","white","white"))
ggsave("MM_PK_Imp_gene_Exp_UQUA_FCp_MEG3Log.svg", width=15, height=15, units="cm", dpi=96)
barplot( height=MM_PK_Imp_gene_Exp_UQUA_FCp_MEG3Log$value, names=MM_PK_Imp_gene_Exp_UQUA_FCp_MEG3Log$row , density=c(15,15,15,15,15,15,15) , angle=c(45,45,45,45,45,45,45) , col=c("darkgrey","#922B21","#148F77","#1E8449","#EC7063","#48C9B0","#52BE80"),xlab = "Samples", ylab = "Log2(UQUA)",main = "MEG3",width=c(5,5,5,5,5,5))
#MM_PK_Imp_gene_Exp_UQUA_FCp_MEG3Log.svg

MM_PK_Imp_gene_Exp_UQUA_FCp_H19 <- MM_PK_Imp_gene_Exp_UQUA_FCp[grep("H19", MM_PK_Imp_gene_Exp_UQUA_FCp$Gene_name),]
MM_PK_Imp_gene_Exp_UQUA_FCp_H19Log <- data.frame(stack(t(MM_PK_Imp_gene_Exp_UQUA_FCp_H19[,3:9])))

ggplot(MM_PK_Imp_gene_Exp_UQUA_FCp_H19Log)+
  geom_bar(aes(x=row, y=value, col=row, fill=row),stat = "identity")+
  ggtitle("H19")+
  theme_bw()+ scale_color_manual(values=c("darkgrey","red","green","#009A17","darkred","darkgreen","darkgreen"))+ 
  scale_fill_manual(values=c("white","white","white","white","white","white","white"))

ggsave("MM_PK_Imp_gene_Exp_UQUA_FCp_H19Log.svg", width=15, height=15, units="cm", dpi=96)
barplot( height=MM_PK_Imp_gene_Exp_UQUA_FCp_H19Log$value, names=MM_PK_Imp_gene_Exp_UQUA_FCp_H19Log$row , density=c(12,12,12,12,12,12,12) , angle=c(45,45,45,45,45,45,45) , col=c("darkgrey","#922B21","#148F77","#1E8449","#EC7063","#48C9B0","#52BE80"),xlab = "Samples", ylab = "Log2(UQUA)",main = "H19")
#MM_PK_Imp_gene_Exp_UQUA_FCp_H19Log.svg


MM_PK_Imp_gene_Exp_UQUA_FCp_MKRN3 <- MM_PK_Imp_gene_Exp_UQUA_FCp[grep("MKRN3", MM_PK_Imp_gene_Exp_UQUA_FCp$Gene_name),]
MM_PK_Imp_gene_Exp_UQUA_FCp_MKRN3Log <- data.frame(stack(t(MM_PK_Imp_gene_Exp_UQUA_FCp_MKRN3[,c(3:9)])))

ggplot(MM_PK_Imp_gene_Exp_UQUA_FCp_MKRN3Log)+
  geom_bar(aes(x=row, y=value, col=row, fill=row),stat = "identity")+
  ggtitle("MKRN3")+
  theme_bw()+ scale_color_manual(values=c("darkgrey","red","green","#009A17","darkred","darkgreen","darkgreen"))+ 
  scale_fill_manual(values=c("white","white","white","white","white","white","white"))

ggsave("MM_PK_Imp_gene_Exp_UQUA_FCp_MKRN3Log.svg", width=15, height=15, units="cm", dpi=96)
barplot( height=MM_PK_Imp_gene_Exp_UQUA_FCp_MKRN3Log$value, names=MM_PK_Imp_gene_Exp_UQUA_FCp_MKRN3Log$row , density=c(12,12,12,12,12,12,12) , angle=c(45,45,45,45,45,45,45) , col=c("darkgrey","#922B21","#148F77","#1E8449","#EC7063","#48C9B0","#52BE80"),xlab = "Samples", ylab = "Log2(UQUA)",main = "MKRN3")
#MM_PK_Imp_gene_Exp_UQUA_FCp_MKRN3Log.svg

MM_PK_Imp_gene_Exp_UQUA_FCp_NNAT <- MM_PK_Imp_gene_Exp_UQUA_FCp[grep("NNAT", MM_PK_Imp_gene_Exp_UQUA_FCp$Gene_name),]
MM_PK_Imp_gene_Exp_UQUA_FCp_NNATLog <- data.frame(stack(t(MM_PK_Imp_gene_Exp_UQUA_FCp_NNAT[,3:9])))

ggplot(MM_PK_Imp_gene_Exp_UQUA_FCp_NNATLog)+
  geom_bar(aes(x=row, y=value, col=row, fill=row),stat = "identity")+
  ggtitle("NNAT")+
  theme_bw()+ scale_color_manual(values=c("darkgrey","red","green","#009A17","darkred","darkgreen","darkgreen"))+ 
  scale_fill_manual(values=c("white","white","white","white","white","white","white"))

ggsave("MM_PK_Imp_gene_Exp_UQUA_FCp_NNATLog.svg", width=15, height=15, units="cm", dpi=96)
barplot( height=MM_PK_Imp_gene_Exp_UQUA_FCp_NNATLog$value, names=MM_PK_Imp_gene_Exp_UQUA_FCp_NNATLog$row , density=c(12,12,12,12,12,12,12) , angle=c(45,45,45,45,45,45,45) , col=c("darkgrey","#922B21","#148F77","#1E8449","#EC7063","#48C9B0","#52BE80"),xlab = "Samples", ylab = "Log2(UQUA)",main = "NNAT")
#MM_PK_Imp_gene_Exp_UQUA_FCp_NNATLog.svg
...
gplots::heatmap.2(as.matrix(tabcombinedICR_overlap_DNMT3B_ZFP57_peaks_meth),dendrogram='none', Rowv=FALSE, Colv=FALSE,trace='none' , sepcolor="black", sepwidth=c(6,6), col = colorRampPalette(c('white', 'black'))(12), key = FALSE)
...
# Compare with UHRF1 paper
length(unique(ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_genehg38$Gene))
length(unique(ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_genehg38$Gene))
length(unique(ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_genehg38$Gene))
length(unique(ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_genehg38$Gene))

UHRF1_genes_near_1Kb_HyperDMRs <- read.table("UHRF1_ICFX_genes_near_1kb_HyperDMR.txt")
UHRF1_genes_near_1Kb_HypoDMRs <- read.table("UHRF1_ICFX_genes_near_1kb_HypoDMR.txt")
UHRF1_imprinted_genes_near_HypoDMRs <- read.table("UHRF1_imprinted_genes_near_HypoDMRs.txt")
length(unique(UHRF1_genes_near_1Kb_HyperDMRs$V1))
length(unique(UHRF1_genes_near_1Kb_HypoDMRs$V1))
length(unique(UHRF1_imprinted_genes_near_HypoDMRs$V1))
# gene_v_human_out <- read.table("gene_v43_human_out.txt", header = F, stringsAsFactors = F)
# head(gene_v_human_out)
# colnames(gene_v_human_out) <- c("chr", "start", "end", "strand", "type", "ensID", "gene")
# UHRF1_genes_near_1Kb_HyperDMRs_ensID <- merge(UHRF1_genes_near_1Kb_HyperDMRs, gene_v_human_out, by.x="V1", by.y="gene", all.x=T)
# UHRF1_genes_near_1Kb_HyperDMRs_notassigned <- UHRF1_genes_near_1Kb_HyperDMRs_ensID[is.na(UHRF1_genes_near_1Kb_HyperDMRs_ensID$ensID),]

ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_genehg38_disl1000 <- ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_genehg38[which(ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_genehg38$Distance < 1000),]
ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_genehg38_disl1000 <- ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_genehg38[which(ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_genehg38$Distance < 1000),]
write.table(ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_genehg38_disl1000$Gene, "ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_genehg38_disl1000_gene.txt", sep="\t", quote = F, row.names = F, col.names = F)
write.table(ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_genehg38_disl1000$Gene, "ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_genehg38_disl1000_gene.txt", sep="\t", quote = F, row.names = F, col.names = F)

length(intersect(unique(ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_genehg38_disl1000$Gene), unique(UHRF1_genes_near_1Kb_HyperDMRs$V1)))
length(intersect(unique(ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_genehg38_disl1000$Gene), unique(UHRF1_genes_near_1Kb_HypoDMRs$V1)))
length(intersect(unique(ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_genehg38_disl1000$Gene), unique(UHRF1_imprinted_genes_near_HypoDMRs$V1)))
length(intersect(unique(ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_genehg38_disl1000$Gene), unique(UHRF1_genes_near_1Kb_HyperDMRs$V1)))
length(intersect(unique(ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_genehg38_disl1000$Gene), unique(UHRF1_genes_near_1Kb_HypoDMRs$V1)))
length(intersect(unique(ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_genehg38_disl1000$Gene), unique(UHRF1_imprinted_genes_near_HypoDMRs$V1)))

ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_genehg38_disl1000 <- ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_genehg38[which(ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_genehg38$Distance < 1000),]
ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_genehg38_disl1000 <- ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_genehg38[which(ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_genehg38$Distance < 1000),]
write.table(ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_genehg38_disl1000$Gene, "ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_genehg38_disl1000_gene.txt", sep="\t", quote = F, row.names = F, col.names = F)
write.table(ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_genehg38_disl1000$Gene, "ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_genehg38_disl1000_gene.txt", sep="\t", quote = F, row.names = F, col.names = F)


length(intersect(unique(ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_genehg38_disl1000$Gene), unique(UHRF1_genes_near_1Kb_HyperDMRs$V1)))
length(intersect(unique(ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_genehg38_disl1000$Gene), unique(UHRF1_genes_near_1Kb_HypoDMRs$V1)))
length(intersect(unique(ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_genehg38_disl1000$Gene), unique(UHRF1_imprinted_genes_near_HypoDMRs$V1)))
length(intersect(unique(ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_genehg38_disl1000$Gene), unique(UHRF1_genes_near_1Kb_HyperDMRs$V1)))
length(intersect(unique(ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_genehg38_disl1000$Gene), unique(UHRF1_genes_near_1Kb_HypoDMRs$V1)))
length(intersect(unique(ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_genehg38_disl1000$Gene), unique(UHRF1_imprinted_genes_near_HypoDMRs$V1)))

imprintedgenes <- read.table("imprintedgenes.txt")
imprintedgenes <- unique(imprintedgenes$V1)
length(intersect(unique(ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_genehg38_disl1000$Gene), unique(imprintedgenes)))
length(intersect(unique(ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_genehg38_disl1000$Gene), unique(imprintedgenes)))
length(intersect(unique(ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_genehg38_disl1000$Gene), unique(imprintedgenes)))
length(intersect(unique(ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_genehg38_disl1000$Gene), unique(imprintedgenes)))


imprintedgenes_and_aliases <- read.table("imprintedgenes_and_aliases.txt")
imprintedgenes_and_aliases <- unique(imprintedgenes_and_aliases$V1)
length(intersect(unique(ipubcomdataBin500bp_Hypo_PG_1_filtmin2chr_genehg38_disl1000$Gene), unique(imprintedgenes_and_aliases)))
length(intersect(unique(ipubcomdataBin500bp_Hyper_PR_1_filtmin2chr_genehg38_disl1000$Gene), unique(imprintedgenes_and_aliases)))
length(intersect(unique(ipubcomdataBin500bp_Hyper_PG_1_filtmin2chr_genehg38_disl1000$Gene), unique(imprintedgenes_and_aliases)))
length(intersect(unique(ipubcomdataBin500bp_Hypo_PR_1_filtmin2chr_genehg38_disl1000$Gene), unique(imprintedgenes_and_aliases)))

imprintedgenes_and_aliases_col <- read.table("imprintedgenes_and_aliases.txt")
gene_v29_human_out_sorted <- read.table("gene_v29_human_out_sorted.txt")
imprintedgenes_and_aliases_cords <- merge(imprintedgenes_and_aliases_col, gene_v29_human_out_sorted, by.x="V1", by.y="V7")
write.table(imprintedgenes_and_aliases_cords[,c(2:7,1)], "imprintedgenes_and_aliases_cords.txt", sep="\t", quote = F, append = F, col.names = F, row.names = F)
#RNA-Seq imprinted gene get table
#sort -k1,1 -k2,2n imprintedgenes_and_aliases_cords.txt > imprintedgenes_and_aliases_cords_sort.txt
#bedtools closest -a Monk_human_ICR_hg38_sorted.bed -b gene_v29_human_out_sorted.txt -d > Monk_human_ICR_hg38_sorted_nearest_gene.bed
Monk_human_ICR_hg38_sorted_nearest_gene <- read.table("Monk_human_ICR_hg38_sorted_nearest_gene.bed")
Monk_human_ICR_hg38_sorted_nearest_gene_less1kb <- Monk_human_ICR_hg38_sorted_nearest_gene[which(Monk_human_ICR_hg38_sorted_nearest_gene$V13 < 1000),]
Monk_human_ICR_hg38_sorted_nearest_gene_less1kb_genes <- unique(Monk_human_ICR_hg38_sorted_nearest_gene_less1kb$V12)
intersect(Monk_human_ICR_hg38_sorted_nearest_gene_less1kb_genes, imprintedgenes_and_aliases)
#bedtools closest -a Monk_human_ICR_hg38_sorted.bed -b imprintedgenes_and_aliases_cords_sort.txt -d > Monk_human_ICR_hg38_sorted_nearest_imprinted_gene.bed
Monk_human_ICR_hg38_sorted_nearest_impgene <- read.table("Monk_human_ICR_hg38_sorted_nearest_imprinted_gene.bed")
Monk_human_ICR_hg38_sorted_nearest_impgene_less1kb <- Monk_human_ICR_hg38_sorted_nearest_impgene[which(Monk_human_ICR_hg38_sorted_nearest_impgene$V13 < 1000),]
Monk_human_ICR_hg38_sorted_nearest_impgene_less1kb_impgenes <- unique(Monk_human_ICR_hg38_sorted_nearest_impgene_less1kb$V12)
...
# colnames(ICR_overlap_DNMT3B_iPSC_peaks) <- c("ICR", "Condition")
# #ZFP57 hESC
# bedtools intersect -wa -wb -a GSE115387_hES_57_vs_hES_TI_peaks.bed -b /Users/ankitverma/Documents/Home/human_ICR.bed | awk '{print $9"\t""ZFP57_hESC"}' | sort -k1,1 -u > ZFP57_hESC_hg19_GSE115387.bed
# 
# ICR_overlap_ZFP57_hESC_peaks <- read.table("ZFP57_hESC_hg19_GSE115387.bed")
# colnames(ICR_overlap_ZFP57_hESC_peaks) <- c("ICR", "Condition")
# 
# #ZFP57_HEK293 exo ChIP
# cat GSM2466450_ZFP57_peaks_processed_score_signal_exo.bed GSM2466451_ZFP57-rep2_peaks_processed_score_signal_exo.bed > ZFP57_HEK293T_GRCh37.bed
# 
# bedtools intersect -wa -wb -a ZFP57_HEK293T_GRCh37.bed -b /Users/ankitverma/Documents/Home/human_ICR.bed | awk '{print $10"\t""ZFP57_HEK293T"}' | sort -k1,1 -u > ZFP57_HEK293T_GRCh37_GSM2466450_1.bed
# 
# ICR_overlap_ZFP57_HEK293T_peaks <- read.table("ZFP57_HEK293T_GRCh37_GSM2466450_1.bed")
# colnames(ICR_overlap_ZFP57_HEK293T_peaks) <- c("ICR", "Condition")
# 
...
#          border_color = "grey60")
# 
# bedtools intersect -wa -wb -a GSE57989_wt_kap1_peaks.bed -b /Users/ankitverma/Documents/Home/human_ICR.bed | awk '{print $10}' | sort -k1,1 -u
# 
# 
# head(ipubcomdataBin500bp_filt1_counted1)
# dim(ipubcomdataBin500bp_filt1_counted1)
...
# sort -k1,1 -k2,2n ipubcomdataBin500bp_filt1_counted1chr.txt > ipubcomdataBin500bp_filt1_counted1chr.sort.txt
# bedtools closest -wa -wb -a ipubcomdataBin500bp_filt1_counted1chr.sort.txt -b /Users/ankitverma/Documents/Home/gencode.v29.annotation.gene.sort.gtf -d > ipubcomdataBin500bp_filt1_counted1chr_genehg38.txt
# #Collapse genenames and Prepare Table
...
# 
# 
# bedtools intersect -wa -wb -a GSM1003585_hg19_wgEncodeBroadHistoneH1hescH3k09me3StdPk.broadPeak  -b /Users/ankitverma/Documents/Home/human_ICR.bed
# bedtools intersect -wa -wb -a GSE99346_WT_DNMT3B-Input_peaks.bed  -b /Users/ankitverma/Documents/Home/human_ICR.bed
# bedtools intersect -wa -wb -a GSE115387_hES_57_vs_hES_TI_peaks.bed -b /Users/ankitverma/Documents/Home/human_ICR.bed 
# bedtools intersect -wa -wb -a GSE57989_wt_kap1_peaks.bed -b /Users/ankitverma/Documents/Home/human_ICR.bed 
# 
# 
# bedtools intersect -a GSE99346_WT_DNMT3B-Input_peaks.bed -b GSE115387_hES_57_vs_hES_TI_peaks.bed > DNMT3B_ZFP57_hESC.bed
# bedtools intersect -a DNMT3B_ZFP57_hESC.bed -b GSE57989_wt_kap1_peaks.bed > DNMT3B_ZFP57_KAP1_hESC.bed
# bedtools intersect -a DNMT3B_ZFP57_KAP1_hESC.bed -b GSM1003585_hg19_wgEncodeBroadHistoneH1hescH3k09me3StdPk.broadPeak > DNMT3B_ZFP57_KAP1_H3K9me3_hESC.bed
# 
# bedtools intersect -wa -wb -a miMERGE_myipubCombat3re_chrpos_avg_PG_Hypo_chr.txt -b DNMT3B_ZFP57_KAP1_H3K9me3_hESC_ICR_hg38.bed > miMERGE_myipubCombat3re_chrpos_avg_PG_Hypo_chr_onsharedcomplexICR.txt
...
# 
# bedtools intersect -wa -wb -a miMERGE_myipubCombat3re_chrpos_avg_PG_Hypo_chr.txt -b DNMT3B_ZFP57_KAP1_H3K9me3_hESC_nonICR_hg38.bed > miMERGE_myipubCombat3re_chrpos_avg_PG_Hypo_chr_onsharedcomplexnonICR.txt
...
# 
# 
# bedtools intersect -wa -wb -a miMERGE_myipubCombat3re_chrpos_avg_PR_Hypo_chr.txt -b DNMT3B_ZFP57_KAP1_H3K9me3_hESC_ICR_hg38.bed > miMERGE_myipubCombat3re_chrpos_avg_PR_Hypo_chr_onsharedcomplexICR.txt
...
# 
# bedtools intersect -wa -wb -a miMERGE_myipubCombat3re_chrpos_avg_PR_Hypo_chr.txt -b DNMT3B_ZFP57_KAP1_H3K9me3_hESC_nonICR_hg38.bed > miMERGE_myipubCombat3re_chrpos_avg_PR_Hypo_chr_onsharedcomplexnonICR.txt
...
# bedtools intersect -wa -wb -a DNMT3B_ZFP57_KAP1_H3K9me3_hESC.bed -b /Users/ankitverma/Documents/Home/human_ICR.bed | awk '{print $1"\t"$2"\t"$3}' > DNMT3B_ZFP57_KAP1_H3K9me3_hESC_ICR_hg19.bed
# bedtools intersect -wa -wb -a DNMT3B_ZFP57_KAP1_H3K9me3_hESC.bed -b /Users/ankitverma/Documents/Home/human_ICR.bed -v | awk '{print $1"\t"$2"\t"$3}' > DNMT3B_ZFP57_KAP1_H3K9me3_hESC_nonICR_hg19.bed
# #Liftover UCSC
# bedtools intersect -wa -wb -a miMERGE_myipubCombat3re_chrpos_avg_PG_Hypo_chr.txt -b DNMT3B_ZFP57_KAP1_H3K9me3_hESC_ICR_hg38.bed | wc -l 
# bedtools intersect -wa -wb -a miMERGE_myipubCombat3re_chrpos_avg_PG_Hypo_chr.txt -b DNMT3B_ZFP57_KAP1_H3K9me3_hESC_nonICR_hg38.bed | wc -l 
# bedtools intersect -wa -wb -a miMERGE_myipubCombat3re_chrpos_avg_PR_Hypo_chr.txt -b DNMT3B_ZFP57_KAP1_H3K9me3_hESC_ICR_hg38.bed | wc -l 
# bedtools intersect -wa -wb -a miMERGE_myipubCombat3re_chrpos_avg_PR_Hypo_chr.txt -b DNMT3B_ZFP57_KAP1_H3K9me3_hESC_nonICR_hg38.bed | wc -l 
# 
# bedtools intersect -wa -wb -a MERGE_myiCombat3re_pos_chr.txt -b DNMT3B_ZFP57_KAP1_H3K9me3_hESC_ICR_hg38.bed | wc -l 
# bedtools intersect -wa -wb -a MERGE_myiCombat3re_pos_chr.txt -b DNMT3B_ZFP57_KAP1_H3K9me3_hESC_nonICR_hg38.bed | wc -l 
# 
# 
# 
# #DNMT3B_ZFP57_KAP1_hESC.bed
# bedtools intersect -wa -wb -a DNMT3B_ZFP57_KAP1_hESC.bed -b /Users/ankitverma/Documents/Home/human_ICR.bed | awk '{print $1"\t"$2"\t"$3}' > DNMT3B_ZFP57_KAP1_hESC_ICR_hg19.bed
# bedtools intersect -wa -wb -a DNMT3B_ZFP57_KAP1_hESC.bed -b /Users/ankitverma/Documents/Home/human_ICR.bed -v | awk '{print $1"\t"$2"\t"$3}' > DNMT3B_ZFP57_KAP1_hESC_nonICR_hg19.bed
# #Liftover UCSC
# bedtools intersect -wa -wb -a miMERGE_myipubCombat3re_chrpos_avg_PG_Hypo_chr.txt -b DNMT3B_ZFP57_KAP1_hESC_ICR_hg38.bed | wc -l #23
# bedtools intersect -wa -wb -a miMERGE_myipubCombat3re_chrpos_avg_PR_Hypo_chr.txt -b DNMT3B_ZFP57_KAP1_hESC_ICR_hg38.bed | wc -l #22
# bedtools intersect -wa -wb -a MERGE_myiCombat3re_pos_chr.txt -b DNMT3B_ZFP57_KAP1_hESC_ICR_hg38.bed | wc -l #34
# bedtools intersect -wa -wb -a miMERGE_myipubCombat3re_chrpos_avg_PG_Hypo_chr.txt -b DNMT3B_ZFP57_KAP1_hESC_nonICR_hg38.bed | wc -l #4
# bedtools intersect -wa -wb -a miMERGE_myipubCombat3re_chrpos_avg_PR_Hypo_chr.txt -b DNMT3B_ZFP57_KAP1_hESC_nonICR_hg38.bed | wc -l #5
# bedtools intersect -wa -wb -a MERGE_myiCombat3re_pos_chr.txt -b DNMT3B_ZFP57_KAP1_hESC_nonICR_hg38.bed | wc -l #44
# 
